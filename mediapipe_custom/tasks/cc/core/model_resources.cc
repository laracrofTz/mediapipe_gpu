...
#include "mediapipe_custom/util/resource_util_custom.h"
#include "mediapipe_custom/util/tflite/error_reporter.h"
...
using ::mediapipe_custom::api2::MakePacket;
using ::mediapipe_custom::api2::Packet;
using ::mediapipe_custom::api2::PacketAdopting;
