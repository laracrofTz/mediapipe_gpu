...
#include "mediapipe_custom/framework/calculator_node.h"
...
#include "mediapipe_custom/framework/graph_runtime_info.pb.h"
...
#include "mediapipe_custom/framework/output_stream_shard.h"
#include "mediapipe_custom/framework/packet.h"
#include "mediapipe_custom/framework/packet_generator_graph.h"
#include "mediapipe_custom/framework/resources_service.h"
#include "mediapipe_custom/framework/scheduler.h"
#include "mediapipe_custom/framework/scheduler_shared.h"
...
#include "mediapipe_custom/framework/tool/graph_runtime_info_logger.h"
...
//   MP_RETURN_IF_ERROR(mediapipe_custom::tool::ParseGraphFromString(kGraphStr,
//   &config)); mediapipe_custom::CalculatorGraph graph;
//   MP_RETURN_IF_ERROR(graph.Initialize(config));
//
//   std::map<std::string, mediapipe_custom::Packet> extra_side_packets;
//   extra_side_packets["video_id"] = mediapipe_custom::MakePacket<std::string>(
//       "3edb9503834e9b42");
...
//       {{"video_id", mediapipe_custom::MakePacket<std::string>("Ex-uGhDzue4")}}));
