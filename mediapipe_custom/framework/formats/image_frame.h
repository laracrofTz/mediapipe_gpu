...
//   ::mediapipe_custom::formats::MatView(&frame);
//
...
//                         rgb_frame.Height());
//   cv::Mat rgb_frame_mat = ::mediapipe_custom::formats::MatView(&rgb_frame);
//   cv::Mat gray_frame_mat = ::mediapipe_custom::formats::MatView(&gray_frame);
//   cv::cvtColor(rgb_frame_mat, gray_frame_mat, CV_RGB2GRAY);
//
// Resize an ImageFrame:
//   ImageFrame small_image(ImageFormat::GRAY8, 10, 10);
//   cv::Mat destination = ::mediapipe_custom::formats::MatView(&small_image);
//   cv::resize(::mediapipe_custom::formats::MatView(&large_image), destination,
