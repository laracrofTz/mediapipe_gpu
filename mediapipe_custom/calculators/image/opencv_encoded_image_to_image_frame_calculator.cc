...
#include "mediapipe_custom/calculators/image/opencv_encoded_image_to_image_frame_calculator.pb.h"
...
class OpenCvEncodedImageToImageFrameCalculator : public CalculatorBase {
 ...
 private:
  mediapipe_custom::OpenCvEncodedImageToImageFrameCalculatorOptions options_;
};
...
absl::Status OpenCvEncodedImageToImageFrameCalculator::Open(
  ...
  options_ =
      cc->Options<mediapipe_custom::OpenCvEncodedImageToImageFrameCalculatorOptions>();
  return absl::OkStatus();
}
