...
TEST(LandmarkConverterTest, ConvertsCustomLandmark) {
  mediapipe_custom::tasks::components::containers::Landmark cpp_landmark = {0.1f, 0.2f,
                                                                     0.3f};
...
TEST(LandmarksConverterTest, ConvertsCustomLandmarks) {
  std::vector<mediapipe_custom::tasks::components::containers::Landmark>
      cpp_landmarks = {
...
TEST(NormalizedLandmarksConverterTest, ConvertsCustomNormalizedLandmarks) {
  std::vector<mediapipe_custom::tasks::components::containers::NormalizedLandmark>
...
TEST(NormalizedLandmarkConverterTest, FreesMemory) {
  mediapipe_custom::tasks::components::containers::NormalizedLandmark cpp_landmark = {
      0.1f, 0.2f, 0.3f, 0.0f, 0.0f, "foo"};
