...
class MultiWorldLandmarksSmoothingCalculator : public NodeIntf {
 public:
  static constexpr Input<std::vector<mediapipe_custom::LandmarkList>> kInLandmarks{
      "LANDMARKS"};
  ...
  static constexpr Input<std::vector<Rect>>::Optional kObjectScaleRoi{
      "OBJECT_SCALE_ROI"};
  static constexpr Output<std::vector<mediapipe_custom::LandmarkList>> kOutLandmarks{
      "FILTERED_LANDMARKS"};
