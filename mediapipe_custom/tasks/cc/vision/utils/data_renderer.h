...
api2::builder::Stream<Image> Render(
    ...
    absl::Span<api2::builder::Stream<mediapipe_custom::RenderData>> render_data_list,
...
api2::builder::Stream<mediapipe_custom::RenderData> RenderLandmarks(
    api2::builder::Stream<mediapipe_custom::NormalizedLandmarkList> landmarks,
...
api2::builder::Stream<mediapipe_custom::RenderData> RenderRect(
