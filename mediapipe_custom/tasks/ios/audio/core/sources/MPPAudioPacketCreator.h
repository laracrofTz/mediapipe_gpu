 ...
 */
+ (mediapipe_custom::Packet)createPacketWithAudioData:(MPPAudioData *)audioData error:(NSError **)error;
 ...
 * returned if an error occurred during the conversion.
 */
+ (mediapipe_custom::Packet)createPacketWithAudioData:(MPPAudioData *)audioData
