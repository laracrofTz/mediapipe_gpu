...
#include "mediapipe_custom/calculators/util/landmarks_refinement_calculator.pb.h"
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::face_landmarker::TensorsToFaceLandmarksGraph); // NOLINT
// clang-format on
