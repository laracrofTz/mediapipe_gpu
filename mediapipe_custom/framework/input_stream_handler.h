...
#include "mediapipe_custom/framework/collection.h"
...
#include "mediapipe_custom/framework/input_stream_shard.h"
...
#define REGISTER_INPUT_STREAM_HANDLER(name)                                    \
  REGISTER_FACTORY_FUNCTION_QUALIFIED(                                         \
      mediapipe_custom::InputStreamHandlerRegistry, input_handler_registration, name, \
