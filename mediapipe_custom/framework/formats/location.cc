...
#include "mediapipe_custom/framework/formats/annotation/locus.pb.h"
#include "mediapipe_custom/framework/formats/annotation/rasterization.pb.h"
#include "mediapipe_custom/framework/port/canonical_errors.h"
#include "mediapipe_custom/framework/port/point2.h"
...
Location Location::CreateBBoxLocation(const ::mediapipe_custom::BoundingBox& bbox) {
...
template <>
::mediapipe_custom::BoundingBox Location::GetBBox<::mediapipe_custom::BoundingBox>() const {
  ABSL_CHECK_EQ(LocationData::BOUNDING_BOX, location_data_.format());
  const auto& box = location_data_.bounding_box();
  ::mediapipe_custom::BoundingBox bounding_box;
...
template <>
::mediapipe_custom::BoundingBox Location::ConvertToBBox<::mediapipe_custom::BoundingBox>(
