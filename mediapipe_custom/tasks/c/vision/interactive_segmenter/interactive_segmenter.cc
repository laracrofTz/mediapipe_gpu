...
#include "mediapipe_custom/tasks/c/vision/interactive_segmenter/interactive_segmenter.h"
...
#include "mediapipe_custom/tasks/cc/components/containers/keypoint.h"
#include "mediapipe_custom/tasks/cc/vision/interactive_segmenter/interactive_segmenter.h"
#include "mediapipe_custom/tasks/cc/vision/utils/image_utils.h"

namespace mediapipe_custom::tasks::c::vision::interactive_segmenter {
...
using ::mediapipe_custom::tasks::vision::interactive_segmenter::InteractiveSegmenter;
typedef ::mediapipe_custom::tasks::vision::interactive_segmenter::RegionOfInterest::
    Format CppRegionOfInterestFormat;
typedef ::mediapipe_custom::tasks::components::containers::NormalizedKeypoint
...
void CppConvertToRegionOfInterest(
    ...
    mediapipe_custom::tasks::vision::interactive_segmenter::RegionOfInterest* out) {
  // Convert format
  switch (in->format) {
...
void CppConvertToInteractiveSegmenterOptions(
    ...
    mediapipe_custom::tasks::vision::interactive_segmenter::
...
InteractiveSegmenter* CppInteractiveSegmenterCreate(
  ...
  auto cpp_options =
      std::make_unique<::mediapipe_custom::tasks::vision::interactive_segmenter::
...
int CppInteractiveSegmenterSegment(void* segmenter, const MpImage* image,
  ...
  mediapipe_custom::tasks::vision::interactive_segmenter::RegionOfInterest roi;
...
void* interactive_segmenter_create(struct InteractiveSegmenterOptions* options,
                                   char** error_msg) {
  return mediapipe_custom::tasks::c::vision::interactive_segmenter::
...
void interactive_segmenter_close_result(ImageSegmenterResult* result) {
  mediapipe_custom::tasks::c::vision::interactive_segmenter::
