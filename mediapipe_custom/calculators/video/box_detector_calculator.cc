...
#include "mediapipe_custom/calculators/video/box_detector_calculator.pb.h"
...
#include "mediapipe_custom/util/tracking/box_detector.h"
#include "mediapipe_custom/util/tracking/box_tracker.h"
#include "mediapipe_custom/util/tracking/box_tracker.pb.h"
#include "mediapipe_custom/util/tracking/flow_packager.pb.h"
#include "mediapipe_custom/util/tracking/tracking.h"
#include "mediapipe_custom/util/tracking/tracking_visualization_utilities.h"
...
absl::Status BoxDetectorCalculator::Close(CalculatorContext* cc) {
  if (write_index_) {
    ...
    MEDIAPIPE_CHECK_OK(mediapipe_custom::file::SetContents(
