...
#include "mediapipe_custom/calculators/image/mask_overlay_calculator.pb.h"
...
using ::mediapipe_custom::MaskOverlayCalculatorOptions_MaskChannel_ALPHA;
using ::mediapipe_custom::MaskOverlayCalculatorOptions_MaskChannel_RED;
using ::mediapipe_custom::MaskOverlayCalculatorOptions_MaskChannel_UNKNOWN;
