...
// default value.
class ValueOrDefaultCalculator : public mediapipe_custom::CalculatorBase {
 public:
  ...
  static mediapipe_custom::Status GetContract(mediapipe_custom::CalculatorContract* cc) {
  ...
  mediapipe_custom::Status Open(mediapipe_custom::CalculatorContext* cc) override {
  ...
  mediapipe_custom::Status Process(mediapipe_custom::CalculatorContext* cc) override {
 ...
 private:
  ...
  mediapipe_custom::Packet default_;
};
