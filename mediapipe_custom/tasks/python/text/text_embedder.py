...
from mediapipe_custom.tasks.cc.text.text_embedder.proto import text_embedder_graph_options_pb2
...
from mediapipe_custom.tasks.python.text.core import base_text_task_api
...
_TEXT_TAG = 'TEXT'
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.text.text_embedder.TextEmbedderGraph'
