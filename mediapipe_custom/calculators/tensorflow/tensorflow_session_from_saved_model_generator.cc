...
#include "mediapipe_custom/calculators/tensorflow/tensorflow_session_from_saved_model_generator.pb.h"
...
// returns a Packet containing a unique_ptr to a mediapipe_custom::TensorFlowSession,
