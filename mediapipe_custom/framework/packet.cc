...
std::string Packet::DebugString() const {
  std::string result = absl::StrCat("mediapipe_custom::Packet with timestamp: ",
...
MEDIAPIPE_REGISTER_TYPE(::mediapipe_custom::Packet, "::mediapipe_custom::Packet", nullptr,
                        nullptr);
MEDIAPIPE_REGISTER_TYPE(::std::vector<::mediapipe_custom::Packet>,
                        "::std::vector<::mediapipe_custom::Packet>", nullptr, nullptr);
MEDIAPIPE_REGISTER_TYPE(::mediapipe_custom::Timestamp, "::mediapipe_custom::Timestamp",
                        nullptr, nullptr);
#define PACKET_PAIR_TYPE ::std::pair<::mediapipe_custom::Packet, ::mediapipe_custom::Packet>
MEDIAPIPE_REGISTER_TYPE(PACKET_PAIR_TYPE,
                        "::std::pair<::mediapipe_custom::Packet,::mediapipe_custom::Packet>",
                        nullptr, nullptr);
#undef PACKET_PAIR_TYPE
#define PACKET_MAP_TYPE ::std::map<std::string, ::mediapipe_custom::Packet>
MEDIAPIPE_REGISTER_TYPE(PACKET_MAP_TYPE,
                        "::std::map<std::string,::mediapipe_custom::Packet>", nullptr,
                        nullptr);
