...
#include "mediapipe_custom/tasks/cc/vision/gesture_recognizer/calculators/combined_prediction_calculator.pb.h"
#include "mediapipe_custom/tasks/cc/vision/gesture_recognizer/calculators/landmarks_to_matrix_calculator.pb.h"
#include "mediapipe_custom/tasks/cc/vision/gesture_recognizer/proto/gesture_classifier_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/gesture_recognizer/proto/gesture_embedder_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/gesture_recognizer/proto/hand_gesture_recognizer_graph_options.pb.h"
...
using ::mediapipe_custom::tasks::components::processors::
    ConfigureTensorsToClassificationCalculator;
using ::mediapipe_custom::tasks::core::ModelAssetBundleResources;
using ::mediapipe_custom::tasks::core::proto::BaseOptions;
using ::mediapipe_custom::tasks::metadata::SetExternalFile;
using ::mediapipe_custom::tasks::vision::gesture_recognizer::proto::
  ...
  absl::StatusOr<Source<ClassificationList>> GetGestureClassificationList(
    ...
    MP_RETURN_IF_ERROR(ConfigureTensorsToClassificationCalculator(
        ...
        &tensors_to_classification.GetOptions<
            mediapipe_custom::TensorsToClassificationCalculatorOptions>()));
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::gesture_recognizer::SingleHandGestureRecognizerGraph);  // NOLINT
// clang-format on
...
// clang-format off
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::gesture_recognizer::MultipleHandGestureRecognizerGraph);  // NOLINT
// clang-format on
