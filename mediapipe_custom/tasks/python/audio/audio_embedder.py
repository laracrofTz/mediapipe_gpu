...
from mediapipe_custom.tasks.cc.audio.audio_embedder.proto import audio_embedder_graph_options_pb2
...
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.audio.audio_embedder.AudioEmbedderGraph'
