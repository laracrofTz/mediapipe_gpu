...
#include "mediapipe_custom/tasks/c/vision/object_detector/object_detector.h"
...
#include "mediapipe_custom/tasks/cc/vision/object_detector/object_detector.h"
#include "mediapipe_custom/tasks/cc/vision/utils/image_utils.h"

namespace mediapipe_custom::tasks::c::vision::object_detector {
...
using ::mediapipe_custom::tasks::vision::ObjectDetector;
using ::mediapipe_custom::tasks::vision::core::RunningMode;
typedef ::mediapipe_custom::tasks::vision::ObjectDetectorResult
...
void CppConvertToDetectorOptions(
    ...
    mediapipe_custom::tasks::vision::ObjectDetectorOptions* out) {
...
ObjectDetector* CppObjectDetectorCreate(const ObjectDetectorOptions& options,
                                        char** error_msg) {
  auto cpp_options =
      std::make_unique<::mediapipe_custom::tasks::vision::ObjectDetectorOptions>();
...
void* object_detector_create(struct ObjectDetectorOptions* options,
                             char** error_msg) {
  return mediapipe_custom::tasks::c::vision::object_detector::CppObjectDetectorCreate(
      *options, error_msg);
}
...
int object_detector_detect_image(void* detector, const MpImage* image,
                                 ObjectDetectorResult* result,
                                 char** error_msg) {
  return mediapipe_custom::tasks::c::vision::object_detector::CppObjectDetectorDetect(
...
int object_detector_detect_for_video(void* detector, const MpImage* image,
                                     ...
                                     ObjectDetectorResult* result,
                                     char** error_msg) {
  return mediapipe_custom::tasks::c::vision::object_detector::
...
void object_detector_close_result(ObjectDetectorResult* result) {
  mediapipe_custom::tasks::c::vision::object_detector::CppObjectDetectorCloseResult(
      result);
}

int object_detector_close(void* detector, char** error_ms) {
  return mediapipe_custom::tasks::c::vision::object_detector::CppObjectDetectorClose(
      detector, error_ms);
}
