...
class NoOp : public mediapipe_custom::api2::Node {
 public:
  static constexpr mediapipe_custom::api2::Input<int>::Optional kInputNotNeeded{"NN"};
  static constexpr mediapipe_custom::api2::Output<int>::Optional kOutputNotNeeded{
      "NN"};
