...
#include "mediapipe_custom/calculators/core/constant_side_packet_calculator.pb.h"
#include "mediapipe_custom/calculators/core/split_vector_calculator.pb.h"
#include "mediapipe_custom/calculators/image/warp_affine_calculator.pb.h"
#include "mediapipe_custom/calculators/tensor/image_to_tensor_calculator.pb.h"
#include "mediapipe_custom/calculators/tensor/tensors_to_landmarks_calculator.pb.h"
#include "mediapipe_custom/calculators/tensor/tensors_to_segmentation_calculator.pb.h"
#include "mediapipe_custom/calculators/util/detections_to_rects_calculator.pb.h"
#include "mediapipe_custom/calculators/util/rect_transformation_calculator.pb.h"
#include "mediapipe_custom/calculators/util/refine_landmarks_from_heatmap_calculator.pb.h"
#include "mediapipe_custom/calculators/util/thresholding_calculator.pb.h"
#include "mediapipe_custom/calculators/util/visibility_copy_calculator.pb.h"
#include "mediapipe_custom/framework/api2/builder.h"
#include "mediapipe_custom/framework/api2/port.h"
#include "mediapipe_custom/framework/api2/stream/get_vector_item.h"
#include "mediapipe_custom/framework/api2/stream/image_size.h"
#include "mediapipe_custom/framework/api2/stream/smoothing.h"
...
#include "mediapipe_custom/framework/subgraph.h"
#include "mediapipe_custom/gpu/gpu_origin.pb.h"
#include "mediapipe_custom/tasks/cc/common.h"
#include "mediapipe_custom/tasks/cc/components/processors/image_preprocessing_graph.h"
#include "mediapipe_custom/tasks/cc/core/model_resources.h"
#include "mediapipe_custom/tasks/cc/core/model_task_graph.h"
#include "mediapipe_custom/tasks/cc/vision/pose_landmarker/proto/pose_landmarks_detector_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/utils/image_tensor_specs.h"
#include "mediapipe_custom/util/graph_builder_utils.h"
...
using ::mediapipe_custom::api2::Input;
using ::mediapipe_custom::api2::Output;
using ::mediapipe_custom::api2::builder::GetImageSize;
using ::mediapipe_custom::api2::builder::Graph;
using ::mediapipe_custom::api2::builder::SmoothLandmarks;
using ::mediapipe_custom::api2::builder::SmoothLandmarksVisibility;
using ::mediapipe_custom::api2::builder::Source;
using ::mediapipe_custom::api2::builder::Stream;
using ::mediapipe_custom::tasks::core::ModelResources;
using ::mediapipe_custom::tasks::vision::pose_landmarker::proto::
...
void ConfigureSplitTensorVectorCalculator(
    mediapipe_custom::SplitVectorCalculatorOptions* options) {
...
void ConfigureTensorsToLandmarksCalculator(
    ...
    mediapipe_custom::TensorsToLandmarksCalculatorOptions* options) {
  ...
  if (sigmoid_activation) {
    options->set_visibility_activation(
        mediapipe_custom::TensorsToLandmarksCalculatorOptions_Activation_SIGMOID);
...
void ConfigureTensorsToSegmentationCalculator(
    mediapipe_custom::TensorsToSegmentationCalculatorOptions* options) {
  options->set_activation(
      mediapipe_custom::TensorsToSegmentationCalculatorOptions_Activation_SIGMOID);
  options->set_gpu_origin(mediapipe_custom::GpuOrigin::TOP_LEFT);
}

void ConfigureRefineLandmarksFromHeatmapCalculator(
    mediapipe_custom::RefineLandmarksFromHeatmapCalculatorOptions* options) {
  // Derived from
...
void ConfigureVisibilityCopyCalculator(
    mediapipe_custom::VisibilityCopyCalculatorOptions* options) {
  // Derived from
  // mediapipe/modules/pose_landmark/tensors_to_pose_landmarks_and_segmentation.pbtxt
...
void ConfigureRectTransformationCalculator(
    mediapipe_custom::RectTransformationCalculatorOptions* options) {
...
void ConfigureAlignmentPointsRectsCalculator(
    mediapipe_custom::DetectionsToRectsCalculatorOptions* options) {
  // Derived from
...
void ConfigureWarpAffineCalculator(
    mediapipe_custom::WarpAffineCalculatorOptions* options) {
  options->set_border_mode(mediapipe_custom::WarpAffineCalculatorOptions::BORDER_ZERO);
  options->set_gpu_origin(mediapipe_custom::GpuOrigin::TOP_LEFT);
}
...
Stream<int> CreateIntConstantStream(Stream<TickT> tick_stream, int constant_int,
  ...
  constant_side_packet_node
      .GetOptions<mediapipe_custom::ConstantSidePacketCalculatorOptions>()
      .add_packet()
  ...
  BuildSinglePoseLandmarksDetectorGraph(
    ...
    ConfigureSplitTensorVectorCalculator(
        &split_tensors_vector
             .GetOptions<mediapipe_custom::SplitVectorCalculatorOptions>());
    ...
    pose_presence_thresholding
        .GetOptions<mediapipe_custom::ThresholdingCalculatorOptions>()
    ...
    ConfigureTensorsToLandmarksCalculator(
        ...
        &tensors_to_landmarks
             .GetOptions<mediapipe_custom::TensorsToLandmarksCalculatorOptions>());
    ...
    ConfigureRefineLandmarksFromHeatmapCalculator(
        &refine_landmarks_from_heatmap.GetOptions<
            mediapipe_custom::RefineLandmarksFromHeatmapCalculatorOptions>());
    ...
    ConfigureVisibilityCopyCalculator(
        &visibility_copy
             .GetOptions<mediapipe_custom::VisibilityCopyCalculatorOptions>());
    ...
    if (output_segmentation_mask) {
      ...
      ConfigureTensorsToSegmentationCalculator(
          &tensors_to_segmentation.GetOptions<
              mediapipe_custom::TensorsToSegmentationCalculatorOptions>());
      ...
      ConfigureWarpAffineCalculator(
          &warp_affine.GetOptions<mediapipe_custom::WarpAffineCalculatorOptions>());
    ...
    ConfigureAlignmentPointsRectsCalculator(
        &detection_to_rect
             .GetOptions<mediapipe_custom::DetectionsToRectsCalculatorOptions>());
    ...
    ConfigureRectTransformationCalculator(
        &rect_transformation
             .GetOptions<mediapipe_custom::RectTransformationCalculatorOptions>());
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::pose_landmarker::SinglePoseLandmarksDetectorGraph); // NOLINT
// clang-format on
...
// clang-format off
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::pose_landmarker::MultiplePoseLandmarksDetectorGraph); // NOLINT
// clang-format on
