...
#include "mediapipe_custom/graphs/instant_motion_tracking/calculators/sticker_buffer.pb.h"
...
class StickerManagerCalculator : public CalculatorBase {
 public:
  ...
  absl::Status Process(CalculatorContext* cc) override {
    ...
    ::mediapipe_custom::StickerRoll sticker_roll;
    ...
    for (int i = 0; i < sticker_roll.sticker().size(); ++i) {
      ...
      ::mediapipe_custom::Sticker sticker = sticker_roll.sticker(i);
