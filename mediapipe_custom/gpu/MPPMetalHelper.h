...
- (instancetype)initWithSidePackets:(const mediapipe_custom::PacketSet&)inputSidePackets;
...
+ (absl::Status)setupInputSidePackets:(mediapipe_custom::PacketTypeSet*)inputSidePackets;
...
- (CVMetalTextureRef)copyCVMetalTextureWithGpuBuffer:(const mediapipe_custom::GpuBuffer&)gpuBuffer;
...
- (id<MTLTexture>)metalTextureWithGpuBuffer:(const mediapipe_custom::GpuBuffer&)gpuBuffer;
...
- (mediapipe_custom::GpuBuffer)mediapipeGpuBufferWithWidth:(int)width height:(int)height;

/// Obtains a new GpuBuffer to be used as an output destination.
- (mediapipe_custom::GpuBuffer)mediapipeGpuBufferWithWidth:(int)width
                                             height:(int)height
                                             format:(mediapipe_custom::GpuBufferFormat)format;
