...
class InferenceOnDiskCacheHelper {
 public:
  absl::Status Init(const mediapipe_custom::InferenceCalculatorOptions& options,
 ...
 private:
  ...
  mediapipe_custom::InferenceCalculatorOptions::Delegate::Gpu::CacheWritingBehavior
