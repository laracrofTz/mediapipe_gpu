...
#include "mediapipe_custom/tasks/c/vision/pose_landmarker/pose_landmarker.h"
...
#include "mediapipe_custom/tasks/c/vision/pose_landmarker/pose_landmarker_result.h"
#include "mediapipe_custom/tasks/c/vision/pose_landmarker/pose_landmarker_result_converter.h"
#include "mediapipe_custom/tasks/cc/vision/core/running_mode.h"
#include "mediapipe_custom/tasks/cc/vision/pose_landmarker/pose_landmarker.h"
...
namespace mediapipe_custom::tasks::c::vision::pose_landmarker {
...
using ::mediapipe_custom::tasks::vision::pose_landmarker::PoseLandmarker;
typedef ::mediapipe_custom::tasks::vision::pose_landmarker::PoseLandmarkerResult
...
void CppConvertToPoseLandmarkerOptions(
    ...
    mediapipe_custom::tasks::vision::pose_landmarker::PoseLandmarkerOptions* out) {
...
PoseLandmarker* CppPoseLandmarkerCreate(const PoseLandmarkerOptions& options,
  ...
  auto cpp_options = std::make_unique<
      ::mediapipe_custom::tasks::vision::pose_landmarker::PoseLandmarkerOptions>();
...
void* pose_landmarker_create(struct PoseLandmarkerOptions* options,
                             char** error_msg) {
  return mediapipe_custom::tasks::c::vision::pose_landmarker::CppPoseLandmarkerCreate(
      *options, error_msg);
}
...
int pose_landmarker_detect_image(void* landmarker, const MpImage* image,
                                 PoseLandmarkerResult* result,
                                 char** error_msg) {
  return mediapipe_custom::tasks::c::vision::pose_landmarker::CppPoseLandmarkerDetect(
...
int pose_landmarker_detect_for_video(void* landmarker, const MpImage* image,
                                     ...
                                     PoseLandmarkerResult* result,
                                     char** error_msg) {
  return mediapipe_custom::tasks::c::vision::pose_landmarker::
...
void pose_landmarker_close_result(PoseLandmarkerResult* result) {
  mediapipe_custom::tasks::c::vision::pose_landmarker::CppPoseLandmarkerCloseResult(
      result);
}

int pose_landmarker_close(void* landmarker, char** error_ms) {
  return mediapipe_custom::tasks::c::vision::pose_landmarker::CppPoseLandmarkerClose(
      landmarker, error_ms);
}
