...
#include "mediapipe_custom/framework/platform_specific_profiling.h"
...
#define MEDIAPIPE_PROFILER_SCOPE_INTERNAL(event_type, calculator_context) \
  mediapipe_custom::GraphProfiler::Scope graph_profiler_scope(                   \
      mediapipe_custom::TraceEvent::event_type, calculator_context,              \
