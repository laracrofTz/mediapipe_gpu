...
+ (MPPHandLandmarkerResult *)
    handLandmarkerResultWithLandmarksPacket:(const mediapipe_custom::Packet &)handLandmarksPacket
    ...
    handLandmarkerResultWithLandmarksProto:
        (const std::vector<::mediapipe_custom::NormalizedLandmarkList> &)landmarksProto
                       worldLandmarksProto:
                           ...
                           handednessProto:
                               (const std::vector<::mediapipe_custom::ClassificationList> &)handednessProto
