...
+ (MPPClassifications *)classificationsWithClassificationListProto:
                            (const ::mediapipe_custom::ClassificationList &)proto
...
+ (MPPClassifications *)classificationsWithClassificationsProto:
    (const mediapipe_custom::tasks::components::containers::proto::Classifications &)classificationsProto;
...
+ (MPPClassificationResult *)classificationResultWithProto:
    (const mediapipe_custom::tasks::components::containers::proto::ClassificationResult &)
