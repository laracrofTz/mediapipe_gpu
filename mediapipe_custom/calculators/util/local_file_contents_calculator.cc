...
#include "mediapipe_custom/calculators/util/local_file_contents_calculator.pb.h"
...
class LocalFileContentsCalculator : public CalculatorBase {
 public:
  ...
  absl::Status Open(CalculatorContext* cc) override {
    ...
    auto options = cc->Options<mediapipe_custom::LocalFileContentsCalculatorOptions>();
