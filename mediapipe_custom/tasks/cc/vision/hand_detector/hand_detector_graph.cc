...
using ::mediapipe_custom::tasks::vision::hand_detector::proto::
...
void ConfigureNonMaxSuppressionCalculator(
  ...
  options->set_algorithm(
      mediapipe_custom::NonMaxSuppressionCalculatorOptions::WEIGHTED);
 ...
 private:
  ...
  absl::StatusOr<HandDetectionOuts> BuildHandDetectionSubgraph(
    ...
    auto& ssd_anchor_options =
        ssd_anchor.GetOptions<mediapipe_custom::SsdAnchorsCalculatorOptions>();
    if (!has_metadata) {
    ...
    clip_normalized_rect_vector_size
        .GetOptions<mediapipe_custom::ClipVectorSizeCalculatorOptions>()
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::hand_detector::HandDetectorGraph);
