...
#include "mediapipe_custom/java/com/google/mediapipe/framework/jni/register_natives.h"

#include "absl/log/absl_log.h"
#include "absl/strings/str_format.h"
#include "mediapipe_custom/java/com/google/mediapipe/framework/jni/class_registry.h"

#if defined(__ANDROID__)
#include "mediapipe_custom/java/com/google/mediapipe/framework/jni/android_asset_util_jni.h"
#include "mediapipe_custom/java/com/google/mediapipe/framework/jni/android_packet_creator_jni.h"
#endif
#include "mediapipe_custom/java/com/google/mediapipe/framework/jni/compat_jni.h"
#include "mediapipe_custom/java/com/google/mediapipe/framework/jni/graph_jni.h"
#include "mediapipe_custom/java/com/google/mediapipe/framework/jni/graph_profiler_jni.h"
#include "mediapipe_custom/java/com/google/mediapipe/framework/jni/packet_context_jni.h"
...
void AddJNINativeMethod(std::vector<JNINativeMethodStrings>* methods,
  ...
  auto& class_registry = mediapipe_custom::android::ClassRegistry::GetInstance();
...
void RegisterGraphNatives(JNIEnv* env) {
  auto& class_registry = mediapipe_custom::android::ClassRegistry::GetInstance();
  std::string graph(mediapipe_custom::android::ClassRegistry::kGraphClassName);
  ...
  std::string packet_callback_name = class_registry.GetClassName(
      mediapipe_custom::android::ClassRegistry::kPacketCallbackClassName);
  ...
  std::string packet_list_callback_name = class_registry.GetClassName(
      mediapipe_custom::android::ClassRegistry::kPacketListCallbackClassName);
  ...
  AddJNINativeMethod(&graph_methods, graph, "nativeCloseAllPacketSources",
                     "(J)V", (void*)&GRAPH_METHOD(nativeCloseAllPacketSources));
...
void RegisterGraphProfilerNatives(JNIEnv* env) {
  ...
  std::string graph_profiler(
      mediapipe_custom::android::ClassRegistry::kGraphProfilerClassName);
...
void RegisterAndroidAssetUtilNatives(JNIEnv* env) {
  ...
  std::string android_asset_util(
      mediapipe_custom::android::ClassRegistry::kAndroidAssetUtilClassName);
...
void RegisterAndroidPacketCreatorNatives(JNIEnv* env) {
  ...
  std::string android_packet_creator(
      mediapipe_custom::android::ClassRegistry::kAndroidPacketCreatorClassName);
...
void RegisterPacketCreatorNatives(JNIEnv* env) {
  ...
  std::string packet_creator(
      mediapipe_custom::android::ClassRegistry::kPacketCreatorClassName);
  ...
  std::string serialized_message_name = class_registry.GetClassName(
      mediapipe_custom::android::ClassRegistry::kProtoUtilSerializedMessageClassName);
  AddJNINativeMethod(&packet_creator_methods, packet_creator,
                     "nativeCreateProto",
...
void RegisterPacketGetterNatives(JNIEnv* env) {
  ...
  std::string packet_getter(
      mediapipe_custom::android::ClassRegistry::kPacketGetterClassName);
...
void RegisterPacketNatives(JNIEnv* env) {
  auto& class_registry = mediapipe_custom::android::ClassRegistry::GetInstance();
  std::string packet(mediapipe_custom::android::ClassRegistry::kPacketClassName);
...
void RegisterCompatNatives(JNIEnv* env) {
  auto& class_registry = mediapipe_custom::android::ClassRegistry::GetInstance();
  std::string compat(mediapipe_custom::android::ClassRegistry::kCompatClassName);
  ...
  AddJNINativeMethod(&compat_methods, compat, "getCurrentNativeEGLSurface",
                     "(I)J", (void*)&COMPAT_METHOD(getCurrentNativeEGLSurface));
