...
class CalculatorNodeTest : public ::testing::Test {
 ...
 protected:
  void InitializeEnvironment(bool use_tags) {
    ...
    if (use_tags) {
      graph_config = mediapipe_custom::ParseTextProtoOrDie<CalculatorGraphConfig>(
...
TEST_F(CalculatorNodeTest, ShouldGenerateStreamMonitoringInfo) {
  ...
  EXPECT_THAT(stream_monitoring_info.input_stream_infos(0),
              mediapipe_custom::EqualsProto(
                  mediapipe_custom::ParseTextProtoOrDie<InputStreamRuntimeInfo>(R"pb(
  ...
  EXPECT_THAT(stream_monitoring_info.output_stream_infos(0),
              mediapipe_custom::EqualsProto(
                  mediapipe_custom::ParseTextProtoOrDie<OutputStreamRuntimeInfo>(R"pb(
