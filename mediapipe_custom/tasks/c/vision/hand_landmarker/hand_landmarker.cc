...
#include "mediapipe_custom/tasks/c/vision/hand_landmarker/hand_landmarker.h"
...
#include "mediapipe_custom/tasks/c/vision/hand_landmarker/hand_landmarker_result.h"
#include "mediapipe_custom/tasks/c/vision/hand_landmarker/hand_landmarker_result_converter.h"
#include "mediapipe_custom/tasks/cc/vision/core/running_mode.h"
#include "mediapipe_custom/tasks/cc/vision/hand_landmarker/hand_landmarker.h"
#include "mediapipe_custom/tasks/cc/vision/hand_landmarker/hand_landmarker_result.h"
#include "mediapipe_custom/tasks/cc/vision/utils/image_utils.h"

namespace mediapipe_custom::tasks::c::vision::hand_landmarker {
...
using ::mediapipe_custom::tasks::vision::hand_landmarker::HandLandmarker;
typedef ::mediapipe_custom::tasks::vision::hand_landmarker::HandLandmarkerResult
...
void CppConvertToHandLandmarkerOptions(
    ...
    mediapipe_custom::tasks::vision::hand_landmarker::HandLandmarkerOptions* out) {
...
HandLandmarker* CppHandLandmarkerCreate(const HandLandmarkerOptions& options,
  ...
  auto cpp_options = std::make_unique<
      ::mediapipe_custom::tasks::vision::hand_landmarker::HandLandmarkerOptions>();
...
void* hand_landmarker_create(struct HandLandmarkerOptions* options,
                             char** error_msg) {
  return mediapipe_custom::tasks::c::vision::hand_landmarker::CppHandLandmarkerCreate(
      *options, error_msg);
}
...
int hand_landmarker_detect_image(void* landmarker, const MpImage* image,
                                 HandLandmarkerResult* result,
                                 char** error_msg) {
  return mediapipe_custom::tasks::c::vision::hand_landmarker::CppHandLandmarkerDetect(
...
int hand_landmarker_detect_for_video(void* landmarker, const MpImage* image,
                                     ...
                                     HandLandmarkerResult* result,
                                     char** error_msg) {
  return mediapipe_custom::tasks::c::vision::hand_landmarker::
...
void hand_landmarker_close_result(HandLandmarkerResult* result) {
  mediapipe_custom::tasks::c::vision::hand_landmarker::CppHandLandmarkerCloseResult(
      result);
}

int hand_landmarker_close(void* landmarker, char** error_ms) {
  return mediapipe_custom::tasks::c::vision::hand_landmarker::CppHandLandmarkerClose(
      landmarker, error_ms);
}
