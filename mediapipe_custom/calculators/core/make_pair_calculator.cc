...
class MakePairCalculator : public Node {
 public:
  ...
  // Note that currently api2::Packet is a different type from mediapipe_custom::Packet
  static constexpr Output<std::pair<mediapipe_custom::Packet, mediapipe_custom::Packet>>
      kPair{""};
