...
#include "mediapipe_custom/calculators/util/filter_collection_calculator.h"
...
typedef FilterCollectionCalculator<std::vector<::mediapipe_custom::NormalizedRect>>
    FilterNormalizedRectCollectionCalculator;
REGISTER_CALCULATOR(FilterNormalizedRectCollectionCalculator);

typedef FilterCollectionCalculator<std::vector<::mediapipe_custom::LandmarkList>>
...
typedef FilterCollectionCalculator<std::vector<::mediapipe_custom::ClassificationList>>
