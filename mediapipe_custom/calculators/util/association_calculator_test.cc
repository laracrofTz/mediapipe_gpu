...
::mediapipe_custom::Detection DetectionWithRelativeLocationData(double xmin,
                                                         double ymin,
                                                         double width,
                                                         double height) {
  ::mediapipe_custom::Detection detection;
  ::mediapipe_custom::LocationData* location_data = detection.mutable_location_data();
  location_data->set_format(::mediapipe_custom::LocationData::RELATIVE_BOUNDING_BOX);
...
class AssociationDetectionCalculatorTest : public ::testing::Test {
 protected:
  ...
  ::mediapipe_custom::Detection det_0, det_1, det_2, det_3, det_4, det_5;
};
...
TEST_F(AssociationDetectionCalculatorTest, DetectionAssocTest) {
  ...
  auto input_vec_0 = absl::make_unique<std::vector<::mediapipe_custom::Detection>>();
  ...
  auto input_vec_1 = absl::make_unique<std::vector<::mediapipe_custom::Detection>>();
  ...
  auto input_vec_2 = absl::make_unique<std::vector<::mediapipe_custom::Detection>>();
  ...
  const auto& assoc_rects =
      output[0].Get<std::vector<::mediapipe_custom::Detection>>();
...
class AssociationNormRectCalculatorTest : public ::testing::Test {
 protected:
  ...
  ::mediapipe_custom::NormalizedRect nr_0, nr_1, nr_2, nr_3, nr_4, nr_5;
};
...
TEST_F(AssociationNormRectCalculatorTest, NormRectAssocTest) {
  ...
  auto input_vec_0 =
      absl::make_unique<std::vector<::mediapipe_custom::NormalizedRect>>();
  ...
  EXPECT_EQ(1, output.size());
  const auto& assoc_rects =
      output[0].Get<std::vector<::mediapipe_custom::NormalizedRect>>();
