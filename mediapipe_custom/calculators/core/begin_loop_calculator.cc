...
#include "mediapipe_custom/calculators/core/begin_loop_calculator.h"
...
typedef BeginLoopCalculator<std::vector<::mediapipe_custom::NormalizedLandmarkList>>
...
typedef BeginLoopCalculator<std::vector<::mediapipe_custom::NormalizedRect>>
...
typedef BeginLoopCalculator<std::vector<::mediapipe_custom::Detection>>
...
// A calculator to process std::vector<mediapipe_custom::Tensor>.
typedef BeginLoopCalculator<std::vector<Tensor>> BeginLoopTensorCalculator;
REGISTER_CALCULATOR(BeginLoopTensorCalculator);

// A calculator to process std::vector<mediapipe_custom::ImageFrame>.
...
// A calculator to process std::vector<mediapipe_custom::GpuBuffer>.
...
// A calculator to process std::vector<mediapipe_custom::Image>.
