...
#include "mediapipe_custom/framework/formats/tensor/internal.h"
...
#include "mediapipe_custom/framework/formats/hardware_buffer.h"
#include "mediapipe_custom/framework/formats/hardware_buffer_pool.h"
#include "mediapipe_custom/framework/formats/tensor_ahwb_usage.h"
#include "mediapipe_custom/framework/formats/unique_fd.h"
...
#if MEDIAPIPE_OPENGL_ES_VERSION >= MEDIAPIPE_OPENGL_ES_30
  mutable std::shared_ptr<mediapipe_custom::GlContext> gl_context_;
