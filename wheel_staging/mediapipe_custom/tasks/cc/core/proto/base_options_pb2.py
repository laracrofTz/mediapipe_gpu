...
from mediapipe_custom.gpu import gpu_origin_pb2 as mediapipe_dot_gpu_dot_gpu__origin__pb2
from mediapipe_custom.tasks.cc.core.proto import acceleration_pb2 as mediapipe_dot_tasks_dot_cc_dot_core_dot_proto_dot_acceleration__pb2
