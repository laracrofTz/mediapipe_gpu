...
#include "mediapipe_custom/framework/deps/re2.h"
...
#include "mediapipe_custom/gpu/webgpu/webgpu_shader_calculator.pb.h"
#include "mediapipe_custom/gpu/webgpu/webgpu_texture_buffer_3d.h"
#include "mediapipe_custom/gpu/webgpu/webgpu_texture_view.h"
#include "mediapipe_custom/gpu/webgpu/webgpu_utils.h"
...
using ::mediapipe_custom::api2::AnyType;
using ::mediapipe_custom::api2::Input;
using ::mediapipe_custom::api2::NodeImpl;
using ::mediapipe_custom::api2::NodeIntf;
...
class ScopedWebGpuErrorHandler {
 public:
  ScopedWebGpuErrorHandler(
      ...
      mediapipe_custom::Timestamp timestamp = mediapipe_custom::Timestamp::Unset())
 ...
 private:
  ...
  mediapipe_custom::Timestamp timestamp_;
...
class WebGpuShaderCalculator
 ...
 public:
  ...
  static absl::Status UpdateContract(mediapipe_custom::CalculatorContract* cc);
...
absl::Status WebGpuShaderCalculator::UpdateContract(
  ...
  cc->UseService(mediapipe_custom::kWebGpuService);
...
absl::Status WebGpuShaderCalculator::Open(CalculatorContext* cc) {
  ...
  const mediapipe_custom::WebGpuShaderCalculatorOptions& options =
      cc->Options().GetExtension(mediapipe_custom::WebGpuShaderCalculatorOptions::ext);
