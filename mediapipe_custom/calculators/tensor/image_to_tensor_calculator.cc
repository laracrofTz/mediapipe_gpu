...
#include "mediapipe_custom/framework/memory_manager.h"
#include "mediapipe_custom/framework/memory_manager_service.h"
...
#include "mediapipe_custom/gpu/webgpu/webgpu_check.h"

#if !MEDIAPIPE_DISABLE_OPENCV
#include "mediapipe_custom/calculators/tensor/image_to_tensor_converter_opencv.h"
#elif MEDIAPIPE_ENABLE_HALIDE
#include "mediapipe_custom/calculators/tensor/image_to_tensor_converter_frame_buffer.h"
#endif
...
#include "mediapipe_custom/calculators/tensor/image_to_tensor_converter_metal.h"
#include "mediapipe_custom/gpu/MPPMetalHelper.h"
#elif MEDIAPIPE_OPENGL_ES_VERSION >= MEDIAPIPE_OPENGL_ES_31
#include "mediapipe_custom/calculators/tensor/image_to_tensor_converter_gl_buffer.h"
#include "mediapipe_custom/gpu/gl_calculator_helper.h"
#include "mediapipe_custom/gpu/gpu_service.h"
#else
#include "mediapipe_custom/calculators/tensor/image_to_tensor_converter_gl_texture.h"
#include "mediapipe_custom/gpu/gl_calculator_helper.h"
#include "mediapipe_custom/gpu/gpu_service.h"
#if MEDIAPIPE_USE_WEBGPU
#include "mediapipe_custom/gpu/webgpu/image_to_tensor_converter_webgpu_texture.h"
#include "mediapipe_custom/gpu/webgpu/webgpu_service.h"
#include "mediapipe_custom/gpu/webgpu/webgpu_texture_buffer.h"
...
class ImageToTensorCalculator : public Node {
 public:
  static constexpr Input<
      OneOf<mediapipe_custom::Image, mediapipe_custom::ImageFrame>>::Optional kIn{"IMAGE"};
  static constexpr Input<GpuBuffer>::Optional kInGpu{"IMAGE_GPU"};
  static constexpr Input<mediapipe_custom::NormalizedRect>::Optional kInNormRect{
      "NORM_RECT"};
  ...
  static absl::Status UpdateContract(CalculatorContract* cc) {
    const auto& options =
        cc->Options<mediapipe_custom::ImageToTensorCalculatorOptions>();
  ...
  absl::Status Open(CalculatorContext* cc) {
    ...
    options_ = cc->Options<mediapipe_custom::ImageToTensorCalculatorOptions>();
  ...
  absl::Status Process(CalculatorContext* cc) {
    ...
    absl::optional<mediapipe_custom::NormalizedRect> norm_rect;
...
// made available even with MEDIAPIPE_DISABLE_GPU set.
  ...
  mediapipe_custom::ImageToTensorCalculatorOptions options_;
