...
#include "mediapipe_custom/tasks/cc/vision/gesture_recognizer/gesture_recognizer.h"
...
#include "mediapipe_custom/tasks/cc/core/base_task_api.h"
...
#include "mediapipe_custom/tasks/cc/vision/core/base_vision_task_api.h"
...
#include "mediapipe_custom/tasks/cc/vision/gesture_recognizer/proto/gesture_recognizer_graph_options.pb.h"
...
using GestureRecognizerGraphOptionsProto = ::mediapipe_custom::tasks::vision::
  ...
  return {
      {/* gestures= */ {output_packets[kHandGesturesStreamName]
       ...
       {output_packets[kHandednessStreamName]
            .Get<std::vector<mediapipe_custom::ClassificationList>>()},
       /* hand_landmarks= */
       {output_packets[kHandLandmarksStreamName]
            .Get<std::vector<mediapipe_custom::NormalizedLandmarkList>>()},
       /* hand_world_landmarks */
       {output_packets[kHandWorldLandmarksStreamName]
            .Get<std::vector<mediapipe_custom::LandmarkList>>()}},
  };
}

absl::StatusOr<GestureRecognizerResult> GestureRecognizer::RecognizeForVideo(
    mediapipe_custom::Image image, int64_t timestamp_ms,
    std::optional<core::ImageProcessingOptions> image_processing_options) {
  if (image.UsesGpu()) {
    return CreateStatusWithPayload(
        absl::StatusCode::kInvalidArgument,
