...
#include "mediapipe_custom/calculators/util/world_landmark_projection_calculator.h"
...
TEST_P(WorldLandmarkProjectionTest, Passes) {
  ...
  mediapipe_custom::Packet out_packet;
  ...
  EXPECT_THAT(out_packet, mediapipe_custom::PacketContains<LandmarkList>(EqualsProto(
