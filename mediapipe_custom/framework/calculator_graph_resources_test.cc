...
#include "mediapipe_custom/framework/testdata/resource_path.pb.h"
 ...
 public:
  ...
  absl::Status Open(CalculatorContext* cc) override {
    MP_ASSIGN_OR_RETURN(
        ...
        cc->GetResources().Get(
            cc->Options<mediapipe_custom::ResourcePathOptions>().path()));
 ...
 public:
  absl::StatusOr<CalculatorGraphConfig> GetConfig(
    ...
    MP_ASSIGN_OR_RETURN(
        std::unique_ptr<Resource> resource,
        sc->GetResources().Get(
            sc->Options<mediapipe_custom::ResourcePathOptions>().path()));
    Graph graph;
...
CalculatorGraphConfig BuildGraphProducingResourceContentsPackets(
  ...
  subgraph.GetOptions<mediapipe_custom::ResourcePathOptions>().set_path(
  ...
  calculator.GetOptions<mediapipe_custom::ResourcePathOptions>().set_path(
