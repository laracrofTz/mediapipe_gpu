...
// Decodes an image file and returns it as a mediapipe_custom::Image object.
//
...
absl::StatusOr<mediapipe_custom::Image> DecodeImageFromFile(const std::string& path);

// Creates an image and returns it as a mediapipe_custom::Image object.
//
...
absl::StatusOr<Shape> GetImageLikeTensorShape(const mediapipe_custom::Tensor& tensor);
