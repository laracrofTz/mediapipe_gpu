...
#else
  for (const mediapipe_custom::protobuf::Any& options : node_config.node_options()) {
    if (options.Is<T>()) {
...
void SetNodeOptions(CalculatorGraphConfig::Node& node_config, const T& value) {
  ...
  // protobuf::Any is unavailable with third_party/protobuf:protobuf-lite.
#else
  for (mediapipe_custom::protobuf::Any& options :
...
class OptionsMap {
 public:
  ...
  bool Has() const {
    ...
    // protobuf::Any is unavailable with third_party/protobuf:protobuf-lite.
#else
    for (const mediapipe_custom::protobuf::Any& options :
