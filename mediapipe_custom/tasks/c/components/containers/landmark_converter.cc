...
void CppConvertToLandmark(
    const mediapipe_custom::tasks::components::containers::Landmark& in,
    ::Landmark* out) {
  out->x = in.x;
  out->y = in.y;
  out->z = in.z;
...
void CppConvertToNormalizedLandmark(
    const mediapipe_custom::tasks::components::containers::NormalizedLandmark& in,
...
void CppConvertToLandmarks(
    const std::vector<mediapipe_custom::tasks::components::containers::Landmark>& in,
    ::Landmarks* out) {
...
void CppConvertToNormalizedLandmarks(
    const std::vector<
        mediapipe_custom::tasks::components::containers::NormalizedLandmark>& in,
