...
#include "mediapipe_custom/calculators/tensor/tensors_to_audio_calculator.pb.h"
...
using Options = ::mediapipe_custom::TensorsToAudioCalculatorOptions;
...
absl::Status TensorsToAudioCalculator::Open(CalculatorContext* cc) {
  const auto& options =
      cc->Options<mediapipe_custom::TensorsToAudioCalculatorOptions>();
