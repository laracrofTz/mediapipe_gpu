...
#include "mediapipe_custom/tasks/cc/vision/utils/ghum/ghum_utils.h"
...
#include "mediapipe_custom/calculators/util/combine_joints_calculator.h"
#include "mediapipe_custom/calculators/util/combine_joints_calculator.pb.h"
#include "mediapipe_custom/calculators/util/set_joints_visibility_calculator.h"
#include "mediapipe_custom/calculators/util/set_joints_visibility_calculator.pb.h"
...
using ::mediapipe_custom::api2::CombineJointsCalculator;
using ::mediapipe_custom::api2::SetJointsVisibilityCalculator;
...
using ::mediapipe_custom::tasks::vision::pose_landmarker::PoseLandmarkName;
