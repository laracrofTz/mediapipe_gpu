...
==============================================================================*/
#include "mediapipe_custom/tasks/cc/components/processors/classification_postprocessing_graph.h"
...
#include "mediapipe_custom/calculators/tensor/tensors_to_classification_calculator.pb.h"
...
#include "mediapipe_custom/tasks/cc/components/calculators/classification_aggregation_calculator.pb.h"
...
#include "mediapipe_custom/tasks/cc/components/containers/proto/classifications.pb.h"
#include "mediapipe_custom/tasks/cc/components/processors/proto/classification_postprocessing_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/components/processors/proto/classifier_options.pb.h"
...
using ::mediapipe_custom::Tensor;
using ::mediapipe_custom::api2::Input;
using ::mediapipe_custom::api2::Output;
using ::mediapipe_custom::api2::Timestamp;
using ::mediapipe_custom::api2::builder::GenericNode;
using ::mediapipe_custom::api2::builder::Graph;
using ::mediapipe_custom::api2::builder::Source;
using ::mediapipe_custom::tasks::components::containers::proto::ClassificationResult;
...
using TensorsSource = mediapipe_custom::api2::builder::Source<std::vector<Tensor>>;
...
void ConfigureClassificationAggregationCalculator(
    const ModelMetadataExtractor& metadata_extractor,
    mediapipe_custom::ClassificationAggregationCalculatorOptions* options) {
...
class ClassificationPostprocessingGraph : public mediapipe_custom::Subgraph {
 public:
 ...
 private:
  ...
  // tensors (std::vector<mediapipe_custom::Tensor>) and optional timestamps
  ...
  // timestamps_in: (std::vector<mediapipe_custom::Timestamp>) optional collection of
  ...
  BuildClassificationPostprocessing(
    ...
    result_aggregation
        .GetOptions<mediapipe_custom::ClassificationAggregationCalculatorOptions>()
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::components::processors::ClassificationPostprocessingGraph); // NOLINT
// clang-format on
