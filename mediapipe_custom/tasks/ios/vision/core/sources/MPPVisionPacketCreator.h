 ...
 */
+ (mediapipe_custom::Packet)createPacketWithMPPImage:(MPPImage *)image error:(NSError **)error;
 ...
 *    occurred during the conversion.
 */
+ (mediapipe_custom::Packet)createPacketWithMPPImage:(MPPImage *)image
 ...
 */
+ (mediapipe_custom::Packet)createPacketWithNormalizedRect:(mediapipe_custom::NormalizedRect &)normalizedRect;
 ...
 * `MPPRegionOfInterest`.
 */
+ (std::optional<mediapipe_custom::Packet>)createRenderDataPacketWithRegionOfInterest:
