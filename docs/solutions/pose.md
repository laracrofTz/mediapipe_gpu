...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@mediapipe_custom/pose/pose.js" crossorigin="anonymous"></script>
</head>
...
const pose = new Pose({locateFile: (file) => {
  return `https://cdn.jsdelivr.net/npm/@mediapipe_custom/pose/${file}`;
}});
pose.setOptions({
  modelComplexity: 1,
