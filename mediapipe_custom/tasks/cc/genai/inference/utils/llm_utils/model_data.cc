...
#include "mediapipe_custom/tasks/cc/genai/inference/proto/llm_file_metadata.pb.h"
...
// clang-format off
#include "mediapipe_custom/tasks/cc/genai/inference/utils/llm_utils/memory_mapped_file.h"
#include "mediapipe_custom/tasks/cc/genai/inference/utils/llm_utils/scoped_file.h"
// clang-format on
#include "tensorflow/lite/model_builder.h"
#include "tensorflow/lite/schema/schema_generated.h"

namespace mediapipe_custom::tasks::genai::llm_utils {
namespace {

using ::mediapipe_custom::tasks::genai::llm_utils::MemoryMappedFile;
