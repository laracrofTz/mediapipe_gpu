...
#include "mediapipe_custom/framework/port.h"  // NOLINT: provides MEDIAPIPE_ANDROID/IOS
...
int GetXnnpackNumThreads(
    ...
    const mediapipe_custom::InferenceCalculatorOptions::Delegate& opts_delegate) {
