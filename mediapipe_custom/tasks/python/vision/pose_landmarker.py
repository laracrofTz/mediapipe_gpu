...
from mediapipe_custom.tasks.cc.vision.pose_landmarker.proto import pose_landmarker_graph_options_pb2
...
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.vision.pose_landmarker.PoseLandmarkerGraph'
