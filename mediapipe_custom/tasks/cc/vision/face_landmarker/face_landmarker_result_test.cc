...
TEST(FaceLandmarkerResultTest, Succeeds) {
  mediapipe_custom::NormalizedLandmarkList face_landmarks_proto;
  ...
  mediapipe_custom::ClassificationList face_blendshapes_proto;
  ...
  mediapipe_custom::MatrixData matrix_proto;
