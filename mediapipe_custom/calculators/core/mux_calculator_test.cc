...
#include "mediapipe_custom/calculators/core/split_vector_calculator.h"
...
void RunGraph(const std::string& graph_config_proto,
  ...
  CalculatorGraphConfig config =
      mediapipe_custom::ParseTextProtoOrDie<CalculatorGraphConfig>(graph_config_proto);
...
class PassThroughAndTsBoundUpdateNode : public mediapipe_custom::api2::Node {
 public:
  static constexpr mediapipe_custom::api2::Input<int> kInValue{"VALUE"};
  static constexpr mediapipe_custom::api2::Output<int> kOutValue{"VALUE"};
  static constexpr mediapipe_custom::api2::Output<int> kOutTsBoundUpdate{
      "TS_BOUND_UPDATE"};
...
class ToOptionalNode : public mediapipe_custom::api2::Node {
 public:
  static constexpr mediapipe_custom::api2::Input<int> kTick{"TICK"};
  static constexpr mediapipe_custom::api2::Input<int> kInValue{"VALUE"};
  static constexpr mediapipe_custom::api2::Output<absl::optional<int>> kOutValue{
      "OUTPUT"};
