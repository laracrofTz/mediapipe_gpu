...
class AlignHandToPoseInWorldCalculator : public NodeIntf {
 public:
  static constexpr Input<mediapipe_custom::LandmarkList> kInHandLandmarks{
      "HAND_LANDMARKS"};
  static constexpr Input<mediapipe_custom::LandmarkList> kInPoseLandmarks{
      "POSE_LANDMARKS"};
  static constexpr Output<mediapipe_custom::LandmarkList> kOutHandLandmarks{
      "HAND_LANDMARKS"};
  MEDIAPIPE_NODE_INTERFACE(::mediapipe_custom::AlignHandToPoseInWorldCalculator,
