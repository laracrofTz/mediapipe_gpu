...
#include "mediapipe_custom/calculators/tflite/tflite_tensors_to_landmarks_calculator.pb.h"
...
float ApplyActivation(
    ::mediapipe_custom::TfLiteTensorsToLandmarksCalculatorOptions::Activation
        activation,
    float value) {
  switch (activation) {
    case ::mediapipe_custom::TfLiteTensorsToLandmarksCalculatorOptions::SIGMOID:
...
class TfLiteTensorsToLandmarksCalculator : public CalculatorBase {
 ...
 private:
  ...
  ::mediapipe_custom::TfLiteTensorsToLandmarksCalculatorOptions options_;
};
...
absl::Status TfLiteTensorsToLandmarksCalculator::LoadOptions(
  ...
  options_ =
      cc->Options<::mediapipe_custom::TfLiteTensorsToLandmarksCalculatorOptions>();
