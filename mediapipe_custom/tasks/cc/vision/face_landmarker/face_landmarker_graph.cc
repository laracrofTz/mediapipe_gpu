...
#include "mediapipe_custom/calculators/core/clip_vector_size_calculator.pb.h"
#include "mediapipe_custom/calculators/core/concatenate_vector_calculator.h"
#include "mediapipe_custom/calculators/core/gate_calculator.pb.h"
...
#include "mediapipe_custom/calculators/util/association_calculator.pb.h"
#include "mediapipe_custom/calculators/util/collection_has_min_size_calculator.pb.h"
...
#include "mediapipe_custom/tasks/cc/core/model_asset_bundle_resources.h"
...
#include "mediapipe_custom/tasks/cc/metadata/utils/zip_utils.h"
#include "mediapipe_custom/tasks/cc/vision/face_detector/proto/face_detector_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/face_geometry/calculators/geometry_pipeline_calculator.pb.h"
#include "mediapipe_custom/tasks/cc/vision/face_geometry/proto/environment.pb.h"
#include "mediapipe_custom/tasks/cc/vision/face_geometry/proto/face_geometry.pb.h"
#include "mediapipe_custom/tasks/cc/vision/face_geometry/proto/face_geometry_graph_options.pb.h"
...
using ::mediapipe_custom::api2::builder::SidePacket;
using ::mediapipe_custom::api2::builder::Source;
using ::mediapipe_custom::tasks::components::utils::DisallowIf;
using ::mediapipe_custom::tasks::core::ModelAssetBundleResources;
using ::mediapipe_custom::tasks::metadata::SetExternalFile;
using ::mediapipe_custom::tasks::vision::face_detector::proto::
    FaceDetectorGraphOptions;
using ::mediapipe_custom::tasks::vision::face_geometry::proto::Environment;
using ::mediapipe_custom::tasks::vision::face_geometry::proto::FaceGeometry;
using ::mediapipe_custom::tasks::vision::face_landmarker::proto::
    ...
    if (sc->Options<FaceLandmarkerGraphOptions>()
      ...
      MP_RETURN_IF_ERROR(SetSubTaskBaseOptions(
          *model_asset_bundle_resources,
          ...
          !sc->Service(::mediapipe_custom::tasks::core::kModelResourcesCacheService)
               .IsAvailable()));
      if (output_geometry) {
 ...
 private:
  ...
  absl::StatusOr<FaceLandmarkerOutputs> BuildFaceLandmarkerGraph(
    ...
    if (tasks_options.base_options().use_stream_mode()) {
      ...
      face_association.GetOptions<mediapipe_custom::AssociationCalculatorOptions>()
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::face_landmarker::FaceLandmarkerGraph);
