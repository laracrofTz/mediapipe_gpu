...
#include "mediapipe_custom/util/rectangle_util.h"
...
class AssociationCalculator : public CalculatorBase {
 public:
  ...
  absl::Status Open(CalculatorContext* cc) override {
    ...
    options_ = cc->Options<::mediapipe_custom::AssociationCalculatorOptions>();
 ...
 protected:
  ::mediapipe_custom::AssociationCalculatorOptions options_;
