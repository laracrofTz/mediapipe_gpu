...
namespace {
using ::mediapipe_custom::python::RaisePyErrorIfNotOk;
using ::mediapipe_custom::tasks::core::PacketMap;
using ::mediapipe_custom::tasks::core::PacketsCallback;
...
#if !MEDIAPIPE_DISABLE_GPU
        auto gpu_resources_ = mediapipe_custom::GpuResources::Create();
