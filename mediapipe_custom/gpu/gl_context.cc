...
#include "mediapipe_custom/framework/port.h"  // IWYU pragma: keep
...
#include "mediapipe_custom/gpu/gl_context_internal.h"
#include "mediapipe_custom/gpu/gpu_buffer_format.h"

#ifndef __EMSCRIPTEN__
#include "absl/debugging/leak_check.h"
#include "mediapipe_custom/gpu/gl_thread_collector.h"
#endif
...
void GlContext::SetProfilingContext(
    std::shared_ptr<mediapipe_custom::ProfilingContext> profiling_context) {
