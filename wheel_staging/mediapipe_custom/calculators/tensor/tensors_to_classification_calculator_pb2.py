...
from mediapipe_custom.util import label_map_pb2 as mediapipe_dot_util_dot_label__map__pb2
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_TENSORSTOCLASSIFICATIONCALCULATOROPTIONS_LABELITEMSENTRY']._options = None
  _globals['_TENSORSTOCLASSIFICATIONCALCULATOROPTIONS_LABELITEMSENTRY']._serialized_options = b'8\001'
  _globals['_TENSORSTOCLASSIFICATIONCALCULATOROPTIONS'].fields_by_name['ignore_classes']._options = None
  _globals['_TENSORSTOCLASSIFICATIONCALCULATOROPTIONS'].fields_by_name['ignore_classes']._serialized_options = b'\020\001'
  _globals['_TENSORSTOCLASSIFICATIONCALCULATOROPTIONS'].fields_by_name['allow_classes']._options = None
  _globals['_TENSORSTOCLASSIFICATIONCALCULATOROPTIONS'].fields_by_name['allow_classes']._serialized_options = b'\020\001'
