...
// Converts an audio sample buffer list into a `mediapipe_custom::Matrix`.
// Returns an error status on failure.
absl::StatusOr<std::unique_ptr<mediapipe_custom::Matrix>> MediaPipeConvertAudioBufferListToAudioMatrix(
