...
#include "mediapipe_custom/calculators/core/merge_to_vector_calculator.h"
...
typedef MergeToVectorCalculator<mediapipe_custom::Image> MergeImagesToVectorCalculator;
MEDIAPIPE_REGISTER_NODE(MergeImagesToVectorCalculator);

typedef MergeToVectorCalculator<mediapipe_custom::GpuBuffer>
    MergeGpuBuffersToVectorCalculator;
MEDIAPIPE_REGISTER_NODE(MergeGpuBuffersToVectorCalculator);

typedef MergeToVectorCalculator<mediapipe_custom::Detection>
