...
#include "mediapipe_custom/calculators/tensor/tensors_to_floats_calculator.pb.h"
...
#include "mediapipe_custom/framework/calculator_options.pb.h"
...
#include "mediapipe_custom/tasks/cc/components/utils/gate.h"
...
#include "mediapipe_custom/tasks/cc/vision/face_landmarker/proto/face_blendshapes_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/face_landmarker/proto/face_landmarks_detector_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/face_landmarker/proto/tensors_to_face_landmarks_graph_options.pb.h"
...
using ::mediapipe_custom::tasks::components::utils::AllowIf;
...
void ConfigureLandmarksSmoothingCalculator(
    mediapipe_custom::LandmarksSmoothingCalculatorOptions& options) {
...
class SingleFaceLandmarksDetectorGraph : public core::ModelTaskGraph {
 ...
 private:
  ...
  // image_in: (mediapipe_custom::Image) stream to run face landmark detection on.
  ...
  BuildSingleFaceLandmarksDetectorGraph(
    ...
    tensors_to_presence
        .GetOptions<mediapipe_custom::TensorsToFloatsCalculatorOptions>()
        .set_activation(mediapipe_custom::TensorsToFloatsCalculatorOptions::SIGMOID);
    ...
    presence_thresholding.GetOptions<mediapipe_custom::ThresholdingCalculatorOptions>()
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::face_landmarker::SingleFaceLandmarksDetectorGraph); // NOLINT
// clang-format on
  ...
  absl::StatusOr<MultiFaceLandmarksOutputs> BuildFaceLandmarksDetectorGraph(
    ...
    if (face_landmark_subgraph
      ...
      ConfigureLandmarksSmoothingCalculator(
          landmarks_smoothing
              .GetOptions<mediapipe_custom::LandmarksSmoothingCalculatorOptions>());
...
// clang-format off
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::face_landmarker::MultiFaceLandmarksDetectorGraph);
  // NOLINT
// clang-format on
