...
class InferenceCalculator : public NodeIntf {
 public:
  ...
  static constexpr SideInput<
      mediapipe_custom::InferenceCalculatorOptions::Delegate>::Optional kDelegate{
      "DELEGATE"};
  static constexpr SideInput<
      mediapipe_custom::InferenceCalculatorOptions::InputOutputConfig>::Optional
...
class InferenceCalculatorNodeImpl : public NodeImpl<Intf, Impl> {
 ...
 private:
  ...
  static mediapipe_custom::InferenceCalculatorOptions::InputOutputConfig
  GetInputOutputConfig(CalculatorContext* cc) {
    if (InferenceCalculator::kSideInIoMap(cc).IsConnected()) {
      return *InferenceCalculator::kSideInIoMap(cc)
                  .As<mediapipe_custom::InferenceCalculatorOptions::
                          InputOutputConfig>();
    }
    ...
    return mediapipe_custom::InferenceCalculatorOptions::InputOutputConfig();
  }
