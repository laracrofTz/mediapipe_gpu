...
#include "mediapipe_custom/calculators/core/clip_vector_size_calculator.h"
...
typedef ClipVectorSizeCalculator<::mediapipe_custom::NormalizedRect>
    ClipNormalizedRectVectorSizeCalculator;
REGISTER_CALCULATOR(ClipNormalizedRectVectorSizeCalculator);

typedef ClipVectorSizeCalculator<::mediapipe_custom::Detection>
