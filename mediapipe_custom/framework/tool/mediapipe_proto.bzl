...
load("//mediapipe_custom/framework/tool:mediapipe_graph.bzl", "mediapipe_options_library")
load("//mediapipe_custom/framework/tool:mediapipe_proto_allowlist.bzl", "rewrite_target_list")
