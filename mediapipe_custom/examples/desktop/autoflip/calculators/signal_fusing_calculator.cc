...
#include "mediapipe_custom/examples/desktop/autoflip/calculators/signal_fusing_calculator.pb.h"
...
using mediapipe_custom::Packet;
using mediapipe_custom::PacketTypeSet;
using mediapipe_custom::autoflip::DetectionSet;
...
struct Frame {
  ...
  mediapipe_custom::Timestamp time;
};
...
//    }
//  }
class SignalFusingCalculator : public mediapipe_custom::CalculatorBase {
 public:
 ...
 private:
  absl::Status ProcessScene(mediapipe_custom::CalculatorContext* cc);
  std::vector<Packet> GetSignalPackets(mediapipe_custom::CalculatorContext* cc);
...
void SetupTagInput(mediapipe_custom::CalculatorContract* cc) {
...
void SetupOrderedInput(mediapipe_custom::CalculatorContract* cc) {
...
absl::Status SignalFusingCalculator::Open(mediapipe_custom::CalculatorContext* cc) {
...
absl::Status SignalFusingCalculator::Close(mediapipe_custom::CalculatorContext* cc) {
...
absl::Status SignalFusingCalculator::Process(mediapipe_custom::CalculatorContext* cc) {
