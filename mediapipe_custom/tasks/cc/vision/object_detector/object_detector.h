...
using ObjectDetectorResult =
    ::mediapipe_custom::tasks::components::containers::DetectionResult;
...
class ObjectDetector : public tasks::vision::core::BaseVisionTaskApi {
 public:
  ...
  //    Users provide mediapipe_custom::Image to the `Detect` method, and will
  ...
  absl::Status DetectAsync(mediapipe_custom::Image image, int64_t timestamp_ms,
