...
#include "mediapipe_custom/modules/objectron/calculators/frame_annotation_tracker.h"
#include "mediapipe_custom/modules/objectron/calculators/frame_annotation_tracker_calculator.pb.h"
    ...
    if (cc->Outputs().HasTag(kOutputCancelObjectIdTag)) {
      ...
      for (const auto& id : cancel_object_ids) {
        ...
        cc->Outputs()
            ...
            .AddPacket(mediapipe_custom::MakePacket<int>(id).At(packet_timestamp++));
      }
    }
  }
