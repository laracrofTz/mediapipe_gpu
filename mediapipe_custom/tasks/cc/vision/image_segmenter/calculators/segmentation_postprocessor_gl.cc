...
using mediapipe_custom::kBasicSquareVertices;
using mediapipe_custom::kBasicTextureVertices;
using mediapipe_custom::kBasicVertexShader;
...
absl::Status SegmentationPostprocessorGl::CreateBasicFragmentShaderProgram(
  ...
  const std::string frag_shader_source =
      absl::StrCat(is_es30_only ? std::string(kEs30RequirementHeader) : "",
                   std::string(mediapipe_custom::kMediaPipeFragmentShaderPreamble),
...
absl::Status SegmentationPostprocessorGl::GlInit(
  ...
  return helper_.RunInGlContext([this,
    ...
    const std::string split_vertex_shader_source =
        absl::StrCat(std::string(mediapipe_custom::kMediaPipeVertexShaderPreamble),
    ...
    mediapipe_custom::GlhCreateProgram(split_vertex_shader_source.c_str(),
