...
#include "mediapipe_custom/calculators/util/visibility_smoothing_calculator.pb.h"
...
#include "mediapipe_custom/util/filtering/low_pass_filter.h"
...
using mediapipe_custom::LowPassFilter;
