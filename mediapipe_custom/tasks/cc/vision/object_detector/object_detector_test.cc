...
#include "mediapipe_custom/tasks/cc/components/containers/detection_result.h"
...
using ::mediapipe_custom::tasks::components::containers::ConvertToDetectionResult;
using ::mediapipe_custom::tasks::components::containers::Detection;
using ::mediapipe_custom::tasks::components::containers::DetectionResult;
...
using DetectionProto = mediapipe_custom::Detection;
