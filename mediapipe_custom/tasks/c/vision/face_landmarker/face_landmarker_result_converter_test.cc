...
void InitFaceLandmarkerResult(
    ::mediapipe_custom::tasks::vision::face_landmarker::FaceLandmarkerResult*
        cpp_result) {
  ...
  cpp_result->face_blendshapes =
      std::vector<mediapipe_custom::tasks::components::containers::Classifications>{
          classifications_for_blendshapes};
...
TEST(FaceLandmarkerResultConverterTest, ConvertsCustomResult) {
  ...
  ::mediapipe_custom::tasks::vision::face_landmarker::FaceLandmarkerResult cpp_result;
