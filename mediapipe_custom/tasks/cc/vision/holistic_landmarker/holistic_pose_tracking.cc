...
#include "mediapipe_custom/framework/api2/stream/segmentation_smoothing.h"
...
using ::mediapipe_custom::api2::builder::ConvertAlignmentPointsDetectionsToRect;
using ::mediapipe_custom::api2::builder::ConvertAlignmentPointsDetectionToRect;
using ::mediapipe_custom::api2::builder::ConvertLandmarksToDetection;
using ::mediapipe_custom::api2::builder::GenericNode;
using ::mediapipe_custom::api2::builder::GetImageSize;
using ::mediapipe_custom::api2::builder::GetLoopbackData;
using ::mediapipe_custom::api2::builder::Graph;
using ::mediapipe_custom::api2::builder::IsPresent;
using ::mediapipe_custom::api2::builder::Merge;
using ::mediapipe_custom::api2::builder::ScaleAndMakeSquare;
using ::mediapipe_custom::api2::builder::SmoothLandmarks;
using ::mediapipe_custom::api2::builder::SmoothLandmarksVisibility;
using ::mediapipe_custom::api2::builder::SmoothSegmentationMask;
...
TrackHolisticPoseUsingCustomPoseDetection(
  ...
  if (landmarks_detection_result.segmentation_mask) {
    ...
    auto [prev_mask_as_img, set_prev_mask_as_img_fn] =
        GetLoopbackData<mediapipe_custom::Image>(
...
absl::StatusOr<HolisticPoseTrackingOutput> TrackHolisticPose(
  ...
  PoseDetectionFn pose_detection_fn = [&pose_detector_graph_options](
      ...
      -> absl::StatusOr<Stream<std::vector<mediapipe_custom::Detection>>> {
