...
/**
 * Copies the iOS MediaPipe task options to an object of `mediapipe_custom::CalculatorOptions` proto.
 */
- (void)copyToProto:(::mediapipe_custom::CalculatorOptions *)optionsProto;
