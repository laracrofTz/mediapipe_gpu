...
class DetectionsToRectsCalculator : public CalculatorBase {
 ...
 protected:
  virtual absl::Status DetectionToRect(const ::mediapipe_custom::Detection& detection,
                                       const DetectionSpec& detection_spec,
                                       ::mediapipe_custom::Rect* rect);
  virtual absl::Status DetectionToNormalizedRect(
      const ::mediapipe_custom::Detection& detection,
      const DetectionSpec& detection_spec, ::mediapipe_custom::NormalizedRect* rect);
  virtual absl::Status ComputeRotation(const ::mediapipe_custom::Detection& detection,
                                       const DetectionSpec& detection_spec,
                                       float* rotation);
  ...
  ::mediapipe_custom::DetectionsToRectsCalculatorOptions options_;
