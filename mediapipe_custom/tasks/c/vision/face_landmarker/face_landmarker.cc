...
#include "mediapipe_custom/tasks/c/vision/face_landmarker/face_landmarker.h"
...
#include "mediapipe_custom/tasks/c/vision/face_landmarker/face_landmarker_result.h"
#include "mediapipe_custom/tasks/c/vision/face_landmarker/face_landmarker_result_converter.h"
#include "mediapipe_custom/tasks/cc/vision/core/running_mode.h"
#include "mediapipe_custom/tasks/cc/vision/face_landmarker/face_landmarker.h"
...
namespace mediapipe_custom::tasks::c::vision::face_landmarker {
...
using ::mediapipe_custom::tasks::vision::face_landmarker::FaceLandmarker;
typedef ::mediapipe_custom::tasks::vision::face_landmarker::FaceLandmarkerResult
...
void CppConvertToFaceLandmarkerOptions(
    ...
    mediapipe_custom::tasks::vision::face_landmarker::FaceLandmarkerOptions* out) {
...
FaceLandmarker* CppFaceLandmarkerCreate(const FaceLandmarkerOptions& options,
  ...
  auto cpp_options = std::make_unique<
      ::mediapipe_custom::tasks::vision::face_landmarker::FaceLandmarkerOptions>();
...
void* face_landmarker_create(struct FaceLandmarkerOptions* options,
                             char** error_msg) {
  return mediapipe_custom::tasks::c::vision::face_landmarker::CppFaceLandmarkerCreate(
      *options, error_msg);
}
...
int face_landmarker_detect_image(void* landmarker, const MpImage* image,
                                 FaceLandmarkerResult* result,
                                 char** error_msg) {
  return mediapipe_custom::tasks::c::vision::face_landmarker::CppFaceLandmarkerDetect(
...
int face_landmarker_detect_for_video(void* landmarker, const MpImage* image,
                                     ...
                                     FaceLandmarkerResult* result,
                                     char** error_msg) {
  return mediapipe_custom::tasks::c::vision::face_landmarker::
...
void face_landmarker_close_result(FaceLandmarkerResult* result) {
  mediapipe_custom::tasks::c::vision::face_landmarker::CppFaceLandmarkerCloseResult(
      result);
}

int face_landmarker_close(void* landmarker, char** error_ms) {
  return mediapipe_custom::tasks::c::vision::face_landmarker::CppFaceLandmarkerClose(
      landmarker, error_ms);
}
