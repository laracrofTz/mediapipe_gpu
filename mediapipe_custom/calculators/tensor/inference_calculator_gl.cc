...
absl::Status InferenceCalculatorGlImpl::GpuInferenceRunner::Init(
  ...
  mediapipe_custom::InferenceCalculatorOptions::Delegate delegate_options =
      options.delegate();
...
absl::Status InferenceCalculatorGlImpl::GpuInferenceRunner::LoadModel(
  ...
  interpreter_->SetNumThreads(
      cc->Options<mediapipe_custom::InferenceCalculatorOptions>().cpu_num_thread());
...
InferenceCalculatorGlImpl::GpuInferenceRunner::LoadDelegateAndAllocateTensors(
    CalculatorContext* cc,
    const mediapipe_custom::InferenceCalculatorOptions::Delegate& delegate_options) {
