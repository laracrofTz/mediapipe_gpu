...
mediapipe_custom::LandmarksToRenderDataCalculatorOptions GetHandRendererOptions() {
...
absl::StatusOr<std::unique_ptr<tasks::core::TaskRunner>> CreateTaskRunner() {
  ...
  Stream<mediapipe_custom::LandmarkList> pose_world_landmarks =
      graph.In("POSE_WORLD_LANDMARKS")
          .Cast<mediapipe_custom::LandmarkList>()
