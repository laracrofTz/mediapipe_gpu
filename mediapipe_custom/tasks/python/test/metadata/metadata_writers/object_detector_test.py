...
from mediapipe_custom.tasks.metadata import metadata_schema_py_generated as metadata_fb
...
from mediapipe_custom.tasks.python.metadata.metadata_writers import object_detector
