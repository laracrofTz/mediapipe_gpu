...
#include "mediapipe_custom/tasks/cc/text/language_detector/language_detector.h"
...
namespace mediapipe_custom::tasks::text::language_detector {

namespace {

using ::mediapipe_custom::tasks::components::containers::Category;
using ::mediapipe_custom::tasks::components::containers::ClassificationResult;
using ::mediapipe_custom::tasks::components::containers::Classifications;
using ::mediapipe_custom::tasks::components::containers::ConvertToClassificationResult;
using ClassificationResultProto =
    ::mediapipe_custom::tasks::components::containers::proto::ClassificationResult;
using ::mediapipe_custom::tasks::text::text_classifier::proto::
