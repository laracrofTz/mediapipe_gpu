 ...
 * respective masks.
 *
 * @param confidenceMasksPacket A MediaPipe packet wrapping a `std::vector<mediapipe_custom::Image>`.
 * @param categoryMaskPacket A MediaPipe packet wrapping a `<mediapipe_custom::Image>`.
...
+ (MPPImageSegmenterResult *)
    imageSegmenterResultWithConfidenceMasksPacket:(const mediapipe_custom::Packet &)confidenceMasksPacket
                               categoryMaskPacket:(const mediapipe_custom::Packet &)categoryMaskPacket
                              qualityScoresPacket:(const mediapipe_custom::Packet &)qualityScoresPacket
