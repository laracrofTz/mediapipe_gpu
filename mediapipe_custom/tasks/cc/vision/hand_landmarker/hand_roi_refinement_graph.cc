...
using ::mediapipe_custom::api2::builder::ProjectLandmarks;
...
class HandRoiRefinementGraph : public core::ModelTaskGraph {
 public:
  absl::StatusOr<CalculatorGraphConfig> GetConfig(
      mediapipe_custom::SubgraphContext* context) override {
    Graph graph;
    ...
    image_to_tensor_options.set_border_mode(
        mediapipe_custom::ImageToTensorCalculatorOptions::BORDER_REPLICATE);
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::hand_landmarker::HandRoiRefinementGraph);
