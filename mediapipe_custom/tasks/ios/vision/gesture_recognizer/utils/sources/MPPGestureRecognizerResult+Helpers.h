...
+ (MPPGestureRecognizerResult *)
    gestureRecognizerResultWithHandGesturesPacket:(const mediapipe_custom::Packet &)handGesturesPacket
                                 handednessPacket:(const mediapipe_custom::Packet &)handednessPacket
                              handLandmarksPacket:(const mediapipe_custom::Packet &)handLandmarksPacket
...
+ (MPPGestureRecognizerResult *)
    gestureRecognizerResultWithHandGesturesProto:
        (const std::vector<::mediapipe_custom::ClassificationList> &)handGesturesProto
                                 handednessProto:
                                     (const std::vector<::mediapipe_custom::ClassificationList> &)
                                         handednessProto
                              handLandmarksProto:
