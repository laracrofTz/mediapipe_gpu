...
//        ::mediapipe_custom::SerializeUsingGenericFn<::namespace::Type>,
//        ::mediapipe_custom::DeserializeUsingGenericFn<::namespace::Type>);
//
...
//        mediapipe_custom::Location, "mediapipe_custom::Location",
//        ::mediapipe_custom::SerializeUsingGenericFn<Location WITH_MEDIAPIPE_PROXY
//        LocationData>,
//        ::mediapipe_custom::DeserializeUsingGenericFn<Location WITH_MEDIAPIPE_PROXY
...
#include "mediapipe_custom/framework/demangle.h"
...
//     "::map<std::string,mediapipe_custom::Packet>".
//
// Examples:
...
//                         ::mediapipe_custom::SerializeUsingGenericFn<MY_MAP_TYPE>,
//                         ::mediapipe_custom::DeserializeUsingGenericFn<MY_MAP_TYPE>);
//   #undef MY_MAP_TYPE
//
//   MEDIAPIPE_REGISTER_TYPE(
...
#define MEDIAPIPE_REGISTER_TYPE(type, type_name, serialize_fn, deserialize_fn) \
  SET_MEDIAPIPE_TYPE_MAP_VALUE(                                                \
      mediapipe_custom::PacketTypeIdToMediaPipeTypeData,                              \
      mediapipe_custom::TypeId::Of<                                                   \
          mediapipe_custom::type_map_internal::ReflectType<void(type*)>::Type>()      \
          .hash_code(),                                                        \
      (mediapipe_custom::MediaPipeTypeData{                                           \
          mediapipe_custom::TypeId::Of<                                               \
              mediapipe_custom::type_map_internal::ReflectType<void(type*)>::Type>()  \
              .hash_code(),                                                    \
          type_name, serialize_fn, deserialize_fn}));                          \
  SET_MEDIAPIPE_TYPE_MAP_VALUE(                                                \
      mediapipe_custom::PacketTypeStringToMediaPipeTypeData, type_name,               \
      (mediapipe_custom::MediaPipeTypeData{                                           \
          mediapipe_custom::TypeId::Of<                                               \
              mediapipe_custom::type_map_internal::ReflectType<void(type*)>::Type>()  \
              .hash_code(),                                                    \
...
//      ::mediapipe_custom::SerializeUsingGenericFn<ClassType WITH_MEDIAPIPE_PROXY
//      ProxyType>,
//      ::mediapipe_custom::DeserializeUsingGenericFn<ClassType WITH_MEDIAPIPE_PROXY
...
#define MEDIAPIPE_REGISTER_TYPE_WITH_PROXY(                                    \
  ...
  SET_MEDIAPIPE_TYPE_MAP_VALUE(                                                \
      mediapipe_custom::PacketTypeIdToMediaPipeTypeData,                              \
      mediapipe_custom::tool::GetTypeHash<                                            \
          mediapipe_custom::type_map_internal::ReflectType<void(type*)>::Type>(),     \
      (mediapipe_custom::MediaPipeTypeData{                                           \
          mediapipe_custom::tool::GetTypeHash<                                        \
              mediapipe_custom::type_map_internal::ReflectType<void(type*)>::Type>(), \
