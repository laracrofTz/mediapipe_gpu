...
from mediapipe_custom.tasks.python.components.containers import bounding_box as bounding_box_module
...
from mediapipe_custom.tasks.python.vision import face_detector
