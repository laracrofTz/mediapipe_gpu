...
class Location {
 public:
  ...
  static Location CreateBBoxLocation(const ::mediapipe_custom::BoundingBox& bbox);
  ...
  // Rectangle_i and mediapipe.::mediapipe_custom::BoundingBox.
  template <typename T>
  T GetBBox() const;
  ...
  // and mediapipe.::mediapipe_custom::BoundingBox.
  template <typename T>
