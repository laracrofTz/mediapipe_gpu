...
#include "mediapipe_custom/tasks/c/components/processors/embedder_options.h"
#include "mediapipe_custom/tasks/cc/components/processors/embedder_options.h"

namespace mediapipe_custom::tasks::c::components::processors {
...
TEST(EmbedderOptionsConverterTest, ConvertsEmbedderOptionsCustomValues) {
  ...
  mediapipe_custom::tasks::components::processors::EmbedderOptions
