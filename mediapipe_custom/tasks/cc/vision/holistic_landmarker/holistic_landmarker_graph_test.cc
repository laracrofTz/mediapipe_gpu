...
#include "mediapipe_custom/framework/tool/test_util.h"
#include "mediapipe_custom/tasks/cc/core/mediapipe_builtin_op_resolver.h"
#include "mediapipe_custom/tasks/cc/core/proto/base_options.pb.h"
#include "mediapipe_custom/tasks/cc/core/proto/external_file.pb.h"
#include "mediapipe_custom/tasks/cc/core/task_runner.h"
...
#include "mediapipe_custom/tasks/cc/vision/hand_landmarker/hand_landmarks_connections.h"
...
#include "mediapipe_custom/tasks/cc/vision/holistic_landmarker/proto/holistic_landmarker_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/holistic_landmarker/proto/holistic_result.pb.h"
#include "mediapipe_custom/tasks/cc/vision/pose_detector/proto/pose_detector_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/pose_landmarker/pose_landmarks_connections.h"
...
#include "mediapipe_custom/tasks/cc/vision/utils/image_utils.h"
...
using ::mediapipe_custom::tasks::core::TaskRunner;
...
mediapipe_custom::Color GetColor(RenderPart render_part) {
...
mediapipe_custom::LandmarksToRenderDataCalculatorOptions GetRendererOptions(
    const std::array<std::array<int, 2>, N>& connections,
    mediapipe_custom::Color color) {
  mediapipe_custom::LandmarksToRenderDataCalculatorOptions renderer_options;
...
absl::StatusOr<std::unique_ptr<tasks::core::TaskRunner>> CreateTaskRunner(
  ...
  std::vector<Stream<mediapipe_custom::RenderData>> render_list;
  ...
  auto rendered_image =
      utils::Render(
          image, absl::Span<Stream<mediapipe_custom::RenderData>>(render_list), graph)
...
TEST_P(SmokeTest, Succeeds) {
  ...
  cv::Mat matting_mask = mediapipe_custom::formats::MatView(
  ...
  ImageFrame visualized_image(mediapipe_custom::ImageFormat::GRAY8,
