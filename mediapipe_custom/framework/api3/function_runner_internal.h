...
class FunctionRunnerBase {
 ...
 protected:
  mediapipe_custom::Timestamp NextTimestamp() { return ++timestamp_; }
  ...
  GenericGraph graph_;
  std::unique_ptr<mediapipe_custom::CalculatorGraph> calculator_graph_;
  ...
  mediapipe_custom::Timestamp timestamp_ = mediapipe_custom::Timestamp(0);
};
