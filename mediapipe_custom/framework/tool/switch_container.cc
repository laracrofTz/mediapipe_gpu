...
#include "mediapipe_custom/framework/tool/container_util.h"
...
namespace tool {
using mediapipe_custom::SwitchContainerOptions;
...
absl::Status ValidateContract(
  ...
  auto options =
      Subgraph::GetOptions<mediapipe_custom::SwitchContainerOptions>(subgraph_options);
...
absl::StatusOr<CalculatorGraphConfig> SwitchContainer::GetConfig(
  ...
  const auto& switch_options =
      Subgraph::GetOptions<mediapipe_custom::SwitchContainerOptions>(options);
  ...
  auto nodes = Subgraph::GetOptions<mediapipe_custom::SwitchContainerOptions>(options)
                   .contained_node();
