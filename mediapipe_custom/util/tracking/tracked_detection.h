...
class TrackedDetection {
 public:
  ...
  // dimensions.
  TrackedDetection(int unique_id, int64_t timestamp,
                   const ::mediapipe_custom::NormalizedRect& bounding_box)
      : unique_id_(unique_id),
        initial_timestamp_(timestamp),
        last_updated_timestamp_(timestamp),
        previous_id_(-1) {
  ...
  const ::mediapipe_custom::NormalizedRect& bounding_box() const {
  ...
  void set_bounding_box(const ::mediapipe_custom::NormalizedRect& bounding_box) {
 ...
 private:
  ...
  ::mediapipe_custom::NormalizedRect bounding_box_;
  float left_ = 0.f;
  float right_ = 0.f;
  float top_ = 0.f;
  float bottom_ = 0.f;
