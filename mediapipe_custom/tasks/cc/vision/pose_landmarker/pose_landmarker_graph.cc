...
#include "mediapipe_custom/tasks/cc/vision/pose_landmarker/proto/pose_landmarker_graph_options.pb.h"
...
class PoseLandmarkerGraph : public core::ModelTaskGraph {
 ...
 private:
  ...
  // image_in: (mediapipe_custom::Image) stream to run pose landmark detection on.
  ...
  absl::StatusOr<PoseLandmarkerOutputs> BuildPoseLandmarkerGraph(
    ...
    if (tasks_options.base_options().use_stream_mode()) {
      ...
      pose_association.GetOptions<mediapipe_custom::AssociationCalculatorOptions>()
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::pose_landmarker::PoseLandmarkerGraph);
