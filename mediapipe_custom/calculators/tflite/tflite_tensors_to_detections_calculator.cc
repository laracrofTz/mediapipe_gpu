...
#include "mediapipe_custom/calculators/tflite/tflite_tensors_to_detections_calculator.pb.h"
...
class TfLiteTensorsToDetectionsCalculator : public CalculatorBase {
 ...
 private:
  ...
  ::mediapipe_custom::TfLiteTensorsToDetectionsCalculatorOptions options_;
...
absl::Status TfLiteTensorsToDetectionsCalculator::LoadOptions(
  ...
  options_ =
      cc->Options<::mediapipe_custom::TfLiteTensorsToDetectionsCalculatorOptions>();
