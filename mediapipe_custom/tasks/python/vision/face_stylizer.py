...
from mediapipe_custom.tasks.cc.vision.face_stylizer.proto import face_stylizer_graph_options_pb2
...
_IMAGE_TAG = 'IMAGE'
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.vision.face_stylizer.FaceStylizerGraph'
