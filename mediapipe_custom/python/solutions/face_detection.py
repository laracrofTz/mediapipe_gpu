...
from mediapipe_custom.modules.face_detection import face_detection_pb2
...
class FaceDetection(SolutionBase):
  ...
  Please refer to
  https://solutions.mediapipe_custom.dev/face_detection#python-solution-api
  for usage examples.
  """
  ...
  def __init__(self, min_detection_confidence=0.5, model_selection=0):
    ...
    Args:
      min_detection_confidence: Minimum confidence value ([0.0, 1.0]) for face
        ...
        https://solutions.mediapipe_custom.dev/face_detection#min_detection_confidence.
      model_selection: 0 or 1. 0 to select a short-range model that works
        ...
        https://solutions.mediapipe_custom.dev/face_detection#model_selection.
    """
