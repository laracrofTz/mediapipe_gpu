...
#include "mediapipe_custom/util/android/asset_manager_util.h"
#else
#include <fstream>
#include <iostream>
#endif
...
#include "mediapipe_custom/graphs/object_detection_3d/calculators/gl_animation_overlay_calculator.pb.h"
#include "mediapipe_custom/graphs/object_detection_3d/calculators/model_matrix.pb.h"
#include "mediapipe_custom/modules/objectron/calculators/camera_parameters.pb.h"
...
bool GlAnimationOverlayCalculator::LoadAnimationAndroid(
  ...
  mediapipe_custom::AssetManager* mediapipe_asset_manager =
      Singleton<mediapipe_custom::AssetManager>::get();
