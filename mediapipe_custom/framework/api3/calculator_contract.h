...
#include "mediapipe_custom/framework/api3/internal/has_update_contract.h"
...
class CalculatorContract
 ...
 public:
  explicit CalculatorContract(
      mediapipe_custom::CalculatorContract& generic_contract,
  ...
  //   (`GraphServiceRequest::Optional()`).
  mediapipe_custom::CalculatorContract::GraphServiceRequest& UseService(
  ...
  mediapipe_custom::CalculatorContract& GetGenericContract() {
    return generic_contract_;
  }

 private:
  mediapipe_custom::CalculatorContract& generic_contract_;
};
...
class Options<ContractSpecializer, ProtoT> {
 ...
 protected:
  ...
  mediapipe_custom::CalculatorContract* contract_ = nullptr;
};
