...
#include "mediapipe_custom/tasks/cc/vision/utils/landmarks_duplicates_finder.h"
...
class HandLandmarksDeduplicationCalculator : public Node {
 public:
  constexpr static Input<std::vector<mediapipe_custom::NormalizedLandmarkList>>
      kInLandmarks{"MULTI_LANDMARKS"};
  constexpr static Input<std::vector<mediapipe_custom::NormalizedRect>>::Optional
      kInRois{"MULTI_ROIS"};
  constexpr static Input<std::vector<mediapipe_custom::LandmarkList>>::Optional
      kInWorldLandmarks{"MULTI_WORLD_LANDMARKS"};
  constexpr static Input<std::vector<mediapipe_custom::ClassificationList>>::Optional
      kInClassifications{"MULTI_CLASSIFICATIONS"};
  constexpr static Input<std::pair<int, int>> kInSize{"IMAGE_SIZE"};

  constexpr static Output<std::vector<mediapipe_custom::NormalizedLandmarkList>>
      kOutLandmarks{"MULTI_LANDMARKS"};
  constexpr static Output<std::vector<mediapipe_custom::NormalizedRect>>::Optional
      kOutRois{"MULTI_ROIS"};
  constexpr static Output<std::vector<mediapipe_custom::LandmarkList>>::Optional
      kOutWorldLandmarks{"MULTI_WORLD_LANDMARKS"};
  constexpr static Output<std::vector<mediapipe_custom::ClassificationList>>::Optional
