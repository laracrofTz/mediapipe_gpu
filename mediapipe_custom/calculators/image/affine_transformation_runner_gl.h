...
absl::StatusOr<std::unique_ptr<AffineTransformation::Runner<
    mediapipe_custom::GpuBuffer, std::unique_ptr<mediapipe_custom::GpuBuffer>>>>
CreateAffineTransformationGlRunner(
    std::shared_ptr<mediapipe_custom::GlCalculatorHelper> gl_helper,
    mediapipe_custom::GpuOrigin::Mode gpu_origin,
