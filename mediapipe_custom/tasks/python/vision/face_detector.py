...
from mediapipe_custom.tasks.cc.vision.face_detector.proto import face_detector_graph_options_pb2
...
_IMAGE_TAG = 'IMAGE'
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.vision.face_detector.FaceDetectorGraph'
