...
using BoxFormat = ::mediapipe_custom::TensorsToDetectionsCalculatorOptions::BoxFormat;
...
BoxFormat GetBoxFormat(const TensorsToDetectionsCalculatorOptions& options) {
  if (options.has_box_format()) {
    ...
    return mediapipe_custom::TensorsToDetectionsCalculatorOptions::XYWH;
  }
  return mediapipe_custom::TensorsToDetectionsCalculatorOptions::YXHW;
}
...
absl::Status TensorsToDetectionsCalculator::LoadOptions(CalculatorContext* cc) {
  ...
  options_ = cc->Options<::mediapipe_custom::TensorsToDetectionsCalculatorOptions>();
...
absl::Status TensorsToDetectionsCalculator::DecodeBoxes(
  ...
  for (int i = 0; i < num_boxes_; ++i) {
    ...
    switch (box_output_format_) {
      case mediapipe_custom::TensorsToDetectionsCalculatorOptions::UNSPECIFIED:
      case mediapipe_custom::TensorsToDetectionsCalculatorOptions::YXHW:
        y_center = raw_boxes[box_offset];
        x_center = raw_boxes[box_offset + 1];
        h = raw_boxes[box_offset + 2];
        w = raw_boxes[box_offset + 3];
        break;
      case mediapipe_custom::TensorsToDetectionsCalculatorOptions::XYWH:
        x_center = raw_boxes[box_offset];
        y_center = raw_boxes[box_offset + 1];
        w = raw_boxes[box_offset + 2];
        h = raw_boxes[box_offset + 3];
        break;
      case mediapipe_custom::TensorsToDetectionsCalculatorOptions::XYXY:
