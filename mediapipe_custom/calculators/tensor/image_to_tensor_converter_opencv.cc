 ...
 public:
  ...
  absl::Status Convert(const mediapipe_custom::Image& input, const RotatedRect& roi,
    ...
    const bool is_supported_format =
        input.image_format() == mediapipe_custom::ImageFormat::SRGB ||
        input.image_format() == mediapipe_custom::ImageFormat::SRGBA ||
        input.image_format() == mediapipe_custom::ImageFormat::GRAY8;
    ...
    auto src = mediapipe_custom::formats::MatView(&input);
