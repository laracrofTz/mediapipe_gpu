...
#include "mediapipe_custom/tasks/cc/core/proto/acceleration.pb.h"
...
using ::mediapipe_custom::tasks::vision::ImageTensorSpecs;
...
absl::Status ConfigureImageToTensorCalculator(
    ...
    mediapipe_custom::ImageToTensorCalculatorOptions* options) {
...
class ImagePreprocessingGraph : public Subgraph {
 ...
 private:
  ...
  // (mediapipe_custom::Image) and region of interest (mediapipe_custom::NormalizedRect) as
  // inputs and returns 5 output streams:
  //   - the converted tensor (mediapipe_custom::Tensor),
  ...
  // image_in: (mediapipe_custom::Image) stream to preprocess.
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::components::processors::ImagePreprocessingGraph)
