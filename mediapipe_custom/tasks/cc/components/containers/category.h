...
// Utility function to convert from mediapipe_custom::Classification proto to Category
// struct.
Category ConvertToCategory(const mediapipe_custom::Classification& proto);
