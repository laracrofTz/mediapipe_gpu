#include "mediapipe_custom/util/pose_util.h"
...
void DrawPose(const mediapipe_custom::NormalizedLandmarkList& pose, bool flip_y,
              cv::Mat* image) {
...
void DrawFace(const mediapipe_custom::NormalizedLandmarkList& face,
