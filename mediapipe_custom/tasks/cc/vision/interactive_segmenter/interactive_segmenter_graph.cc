...
class AddThicknessToRenderDataCalculator : public api2::Node {
 public:
  ...
  static constexpr api2::Input<mediapipe_custom::RenderData> kRenderDataIn{
      "RENDER_DATA"};
  static constexpr api2::Output<mediapipe_custom::RenderData> kRenderDataOut{
      "RENDER_DATA"};
  ...
  absl::Status Process(CalculatorContext* cc) final {
    mediapipe_custom::RenderData render_data = kRenderDataIn(cc).Get();
...
MEDIAPIPE_REGISTER_NODE(
    ::mediapipe_custom::tasks::vision::interactive_segmenter::internal::AddThicknessToRenderDataCalculator);
// clang-format on
// NOLINTEND
...
Source<> RoiToAlpha(Source<Image> image, Source<RenderData> roi, bool use_gpu,
  ...
  auto& add_thickness = graph.AddNode(
      "mediapipe_custom::tasks::vision::interactive_segmenter::internal::"
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::interactive_segmenter::InteractiveSegmenterGraph);
// clang-format on
