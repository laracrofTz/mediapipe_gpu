...
#include "mediapipe_custom/calculators/tensorflow/tensor_to_image_frame_calculator.pb.h"
 ...
 protected:
  void SetUpRunner(bool scale_per_frame_min_max = false) {
    ...
    config.mutable_options()
        ->MutableExtension(mediapipe_custom::TensorToImageFrameCalculatorOptions::ext)
