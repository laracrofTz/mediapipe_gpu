...
from mediapipe_custom.tasks.cc.vision.object_detector.proto import object_detector_options_pb2
from mediapipe_custom.tasks.python.components.containers import detections as detections_module
...
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.vision.ObjectDetectorGraph'
