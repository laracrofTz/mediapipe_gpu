...
#include "mediapipe_custom/tasks/c/components/containers/classification_result.h"
...
void CppConvertToClassificationResult(
    const mediapipe_custom::tasks::components::containers::ClassificationResult& in,
