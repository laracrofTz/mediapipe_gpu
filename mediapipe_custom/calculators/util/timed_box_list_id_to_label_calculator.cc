...
#include "mediapipe_custom/calculators/util/timed_box_list_id_to_label_calculator.pb.h"
...
using mediapipe_custom::TimedBoxProto;
using mediapipe_custom::TimedBoxProtoList;
...
absl::Status TimedBoxListIdToLabelCalculator::Open(CalculatorContext* cc) {
  ...
  const auto& options =
      cc->Options<::mediapipe_custom::TimedBoxListIdToLabelCalculatorOptions>();
