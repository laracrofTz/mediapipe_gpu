...
#include "mediapipe_custom/tasks/java/com/google/mediapipe/tasks/genai/llminference/jni/llm.h"
...
#include "mediapipe_custom/tasks/java/com/google/mediapipe/tasks/genai/llminference/jni/proto/llm_options.pb.h"
#include "mediapipe_custom/tasks/java/com/google/mediapipe/tasks/genai/llminference/jni/proto/llm_response_context.pb.h"

namespace {

using LlmModelSettingsProto =
    mediapipe_custom::tasks::genai::llminference::jni::LlmModelSettings;
using LlmSessionConfigProto =
    mediapipe_custom::tasks::genai::llminference::jni::LlmSessionConfig;
using LlmResponseContextProto =
    mediapipe_custom::tasks::genai::llminference::jni::LlmResponseContext;
using mediapipe_custom::android::JStringToStdString;
using mediapipe_custom::java::GetJNIEnv;
