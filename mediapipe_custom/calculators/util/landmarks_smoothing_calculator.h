...
class LandmarksSmoothingCalculator : public NodeIntf {
 public:
  static constexpr Input<mediapipe_custom::NormalizedLandmarkList>::Optional
      kInNormLandmarks{"NORM_LANDMARKS"};
  static constexpr Input<mediapipe_custom::LandmarkList>::Optional kInLandmarks{
      "LANDMARKS"};
  ...
  static constexpr Input<OneOf<NormalizedRect, Rect>>::Optional kObjectScaleRoi{
      "OBJECT_SCALE_ROI"};
  static constexpr Output<mediapipe_custom::NormalizedLandmarkList>::Optional
      kOutNormLandmarks{"NORM_FILTERED_LANDMARKS"};
  static constexpr Output<mediapipe_custom::LandmarkList>::Optional kOutLandmarks{
      "FILTERED_LANDMARKS"};
