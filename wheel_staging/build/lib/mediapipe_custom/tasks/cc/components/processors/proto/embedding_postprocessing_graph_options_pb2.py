...
from mediapipe_custom.tasks.cc.components.calculators import tensors_to_embeddings_calculator_pb2 as mediapipe_dot_tasks_dot_cc_dot_components_dot_calculators_dot_tensors__to__embeddings__calculator__pb2
