...
JNIEXPORT void JNICALL GRAPH_PROFILER_METHOD(nativeReset)(JNIEnv* env,
                                                          jobject thiz,
                                                          jlong handle) {
  mediapipe_custom::ProfilingContext* profiling_context =
      reinterpret_cast<mediapipe_custom::ProfilingContext*>(handle);
...
JNIEXPORT jobjectArray JNICALL GRAPH_PROFILER_METHOD(
  ...
  std::vector<mediapipe_custom::CalculatorProfile> profiles_vec;
