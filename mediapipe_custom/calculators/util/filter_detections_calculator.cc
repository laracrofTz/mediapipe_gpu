...
#include "mediapipe_custom/calculators/util/filter_detections_calculator.pb.h"
...
class FilterDetectionsCalculator : public CalculatorBase {
 public:
  ...
  absl::Status Open(CalculatorContext* cc) override {
    ...
    options_ = cc->Options<mediapipe_custom::FilterDetectionsCalculatorOptions>();
 ...
 private:
  mediapipe_custom::FilterDetectionsCalculatorOptions options_;
};
