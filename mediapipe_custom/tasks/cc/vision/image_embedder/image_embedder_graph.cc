...
#include "mediapipe_custom/tasks/cc/vision/image_embedder/proto/image_embedder_graph_options.pb.h"
...
class ImageEmbedderGraph : public core::ModelTaskGraph {
 ...
 private:
  ...
  // (mediapipe_custom::Image) and optional region-of-interest
  // (mediapipe_custom::NormalizedRect) as inputs and returns on embedding result per
  // input image.
  //
  ...
  // image_in: (mediapipe_custom::Image) stream to run embedding extraction on.
  // norm_rect_in: (mediapipe_custom::NormalizedRect) optional region-of-interest to
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::image_embedder::ImageEmbedderGraph);
