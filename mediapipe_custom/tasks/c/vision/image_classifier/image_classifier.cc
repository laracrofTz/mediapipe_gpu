...
#include "mediapipe_custom/tasks/c/vision/image_classifier/image_classifier.h"
...
namespace mediapipe_custom::tasks::c::vision::image_classifier {
...
using ::mediapipe_custom::tasks::vision::image_classifier::ImageClassifier;
typedef ::mediapipe_custom::tasks::vision::image_classifier::ImageClassifierResult
...
ImageClassifier* CppImageClassifierCreate(const ImageClassifierOptions& options,
  ...
  auto cpp_options = std::make_unique<
      ::mediapipe_custom::tasks::vision::image_classifier::ImageClassifierOptions>();
...
void* image_classifier_create(struct ImageClassifierOptions* options,
                              char** error_msg) {
  return mediapipe_custom::tasks::c::vision::image_classifier::
...
void image_classifier_close_result(ImageClassifierResult* result) {
  mediapipe_custom::tasks::c::vision::image_classifier::CppImageClassifierCloseResult(
      result);
}

int image_classifier_close(void* classifier, char** error_ms) {
  return mediapipe_custom::tasks::c::vision::image_classifier::CppImageClassifierClose(
      classifier, error_ms);
}
