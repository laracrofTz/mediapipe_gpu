...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@mediapipe_custom/holistic/holistic.js" crossorigin="anonymous"></script>
</head>
...
const holistic = new Holistic({locateFile: (file) => {
  return `https://cdn.jsdelivr.net/npm/@mediapipe_custom/holistic/${file}`;
}});
holistic.setOptions({
  modelComplexity: 1,
