...
#include "mediapipe_custom/gpu/frame_buffer_view.h"
#include "mediapipe_custom/util/frame_buffer/frame_buffer_util.h"
...
absl::Status ImageToTensorFrameBufferConverter::Convert(
    const mediapipe_custom::Image& input, const RotatedRect& roi, float range_min,
