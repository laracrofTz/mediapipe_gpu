...
#include "mediapipe_custom/tasks/c/vision/image_embedder/image_embedder.h"
...
#include "mediapipe_custom/tasks/c/components/containers/embedding_result.h"
#include "mediapipe_custom/tasks/c/components/containers/embedding_result_converter.h"
#include "mediapipe_custom/tasks/c/components/processors/embedder_options_converter.h"
#include "mediapipe_custom/tasks/c/core/base_options_converter.h"
#include "mediapipe_custom/tasks/c/vision/core/common.h"
#include "mediapipe_custom/tasks/cc/components/containers/embedding_result.h"
#include "mediapipe_custom/tasks/cc/vision/core/running_mode.h"
#include "mediapipe_custom/tasks/cc/vision/image_embedder/image_embedder.h"
#include "mediapipe_custom/tasks/cc/vision/utils/image_utils.h"

namespace mediapipe_custom::tasks::c::vision::image_embedder {

namespace {

using ::mediapipe_custom::tasks::c::components::containers::CppCloseEmbeddingResult;
using ::mediapipe_custom::tasks::c::components::containers::CppConvertToCppEmbedding;
...
using ::mediapipe_custom::tasks::vision::CreateImageFromBuffer;
using ::mediapipe_custom::tasks::vision::core::RunningMode;
using ::mediapipe_custom::tasks::vision::image_embedder::ImageEmbedder;
typedef ::mediapipe_custom::tasks::components::containers::Embedding CppEmbedding;
typedef ::mediapipe_custom::tasks::vision::image_embedder::ImageEmbedderResult
...
ImageEmbedder* CppImageEmbedderCreate(const ImageEmbedderOptions& options,
  ...
  auto cpp_options = std::make_unique<
      ::mediapipe_custom::tasks::vision::image_embedder::ImageEmbedderOptions>();
...
int CppImageEmbedderCosineSimilarity(const Embedding& u, const Embedding& v,
  ...
  auto status_or_similarity =
      mediapipe_custom::tasks::vision::image_embedder::ImageEmbedder::CosineSimilarity(
          cpp_u, cpp_v);
...
void* image_embedder_create(struct ImageEmbedderOptions* options,
                            char** error_msg) {
  return mediapipe_custom::tasks::c::vision::image_embedder::CppImageEmbedderCreate(
      *options, error_msg);
}

int image_embedder_embed_image(void* embedder, const MpImage* image,
                               ImageEmbedderResult* result, char** error_msg) {
  return mediapipe_custom::tasks::c::vision::image_embedder::CppImageEmbedderEmbed(
...
int image_embedder_embed_for_video(void* embedder, const MpImage* image,
                                   ...
                                   ImageEmbedderResult* result,
                                   char** error_msg) {
  return mediapipe_custom::tasks::c::vision::image_embedder::
...
void image_embedder_close_result(ImageEmbedderResult* result) {
  mediapipe_custom::tasks::c::vision::image_embedder::CppImageEmbedderCloseResult(
      result);
}

int image_embedder_close(void* embedder, char** error_msg) {
  return mediapipe_custom::tasks::c::vision::image_embedder::CppImageEmbedderClose(
      embedder, error_msg);
}
