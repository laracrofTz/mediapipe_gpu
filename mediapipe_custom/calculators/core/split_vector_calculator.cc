...
typedef SplitVectorCalculator<mediapipe_custom::NormalizedLandmark, false>
    SplitLandmarkVectorCalculator;
REGISTER_CALCULATOR(SplitLandmarkVectorCalculator);

typedef SplitVectorCalculator<mediapipe_custom::NormalizedLandmarkList, false>
    SplitNormalizedLandmarkListVectorCalculator;
REGISTER_CALCULATOR(SplitNormalizedLandmarkListVectorCalculator);

typedef SplitVectorCalculator<mediapipe_custom::NormalizedRect, false>
...
typedef SplitVectorCalculator<mediapipe_custom::Detection, false>
    SplitDetectionVectorCalculator;
REGISTER_CALCULATOR(SplitDetectionVectorCalculator);

typedef SplitVectorCalculator<mediapipe_custom::ClassificationList, false>
...
typedef SplitVectorCalculator<mediapipe_custom::Image, false>
    SplitImageVectorCalculator;
REGISTER_CALCULATOR(SplitImageVectorCalculator);

typedef SplitVectorCalculator<mediapipe_custom::ImageFrame, true>
