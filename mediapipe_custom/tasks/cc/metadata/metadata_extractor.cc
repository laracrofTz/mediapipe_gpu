...
#include "mediapipe_custom/tasks/cc/metadata/metadata_parser.h"
#include "mediapipe_custom/tasks/cc/metadata/metadata_version_utils.h"
...
using ::mediapipe_custom::tasks::CreateStatusWithPayload;
