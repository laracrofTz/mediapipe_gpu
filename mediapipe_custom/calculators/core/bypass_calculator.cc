...
#include "mediapipe_custom/calculators/core/bypass_calculator.pb.h"
...
using mediapipe_custom::BypassCalculatorOptions;
...
class BypassCalculator : public Node {
 public:
  static constexpr mediapipe_custom::api2::Input<int>::Optional kNotNeeded{"N_N_"};
