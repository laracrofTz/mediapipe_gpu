...
#include "mediapipe_custom/framework/formats/tensor/views/data_types.h"
...
using mediapipe_custom::Float16;
...
class TensorAhwbGpuTest : public mediapipe_custom::GpuTestBase {
 public:
};
