...
int GetMatType(const mediapipe_custom::ImageFormat::Format format) {
  int type = 0;
  switch (format) {
    case mediapipe_custom::ImageFormat::UNKNOWN:
      // Invalid; Default to uchar.
      type = CV_8U;
      break;
    case mediapipe_custom::ImageFormat::SRGB:
      type = CV_8U;
      break;
    ...
    case mediapipe_custom::ImageFormat::GRAY8:
      type = CV_8U;
      break;
    case mediapipe_custom::ImageFormat::GRAY16:
      type = CV_16U;
      break;
    case mediapipe_custom::ImageFormat::YCBCR420P:
      // Invalid; Default to uchar.
      type = CV_8U;
      break;
    case mediapipe_custom::ImageFormat::YCBCR420P10:
      // Invalid; Default to uint16.
      type = CV_16U;
      break;
    case mediapipe_custom::ImageFormat::SRGB48:
      type = CV_16U;
      break;
    case mediapipe_custom::ImageFormat::SRGBA64:
      type = CV_16U;
      break;
    ...
    case mediapipe_custom::ImageFormat::VEC32F4:
      type = CV_32FC4;
      break;
    case mediapipe_custom::ImageFormat::LAB8:
      type = CV_8U;
      break;
    case mediapipe_custom::ImageFormat::SBGRA:
      type = CV_8U;
      break;
    default:
...
std::shared_ptr<cv::Mat> MatView(const mediapipe_custom::Image* image) {
  ...
  struct MatWithPixelLock {
    ...
    // std::make_shared.
    MatWithPixelLock(mediapipe_custom::Image* image) : lock(image) {}
    mediapipe_custom::PixelWriteLock lock;
    cv::Mat mat;
  };
  ...
  const size_t steps[] = {static_cast<size_t>(image->step()),
                          static_cast<size_t>(ImageFrame::ByteDepthForFormat(
                              image->image_format()))};
  auto owner =
      std::make_shared<MatWithPixelLock>(const_cast<mediapipe_custom::Image*>(image));
