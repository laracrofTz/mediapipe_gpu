...
#include "mediapipe_custom/tasks/cc/vision/image_generator/image_generator.h"
...
#include "mediapipe_custom/tasks/cc/vision/core/vision_task_api_factory.h"
...
#include "mediapipe_custom/tasks/cc/vision/image_generator/image_generator_result.h"
...
using ImageGeneratorGraphOptionsProto = ::mediapipe_custom::tasks::vision::
    image_generator::proto::ImageGeneratorGraphOptions;
using ConditionedImageGraphOptionsProto = ::mediapipe_custom::tasks::vision::
    image_generator::proto::ConditionedImageGraphOptions;
using ControlPluginGraphOptionsProto = ::mediapipe_custom::tasks::vision::
    image_generator::proto::ControlPluginGraphOptions;
using FaceLandmarkerGraphOptionsProto = ::mediapipe_custom::tasks::vision::
  ...
  switch (image_generator_options->model_type) {
    case ImageGeneratorOptions::ModelType::SD_1:
      options_proto.mutable_stable_diffusion_iterate_options()->set_model_type(
          mediapipe_custom::StableDiffusionIterateCalculatorOptions::SD_1);
      break;
    default:
