...
#include "mediapipe_custom/python/pybind/packet_creator.h"
...
Packet CreateImageFramePacket(mediapipe_custom::ImageFormat::Format format,
                              const py::array& data, bool copy) {
  if (format == mediapipe_custom::ImageFormat::SRGB ||
  ...
  } else if (format == mediapipe_custom::ImageFormat::GRAY16 ||
  ...
  } else if (format == mediapipe_custom::ImageFormat::VEC32F1 ||
             format == mediapipe_custom::ImageFormat::VEC32F2 ||
             format == mediapipe_custom::ImageFormat::VEC32F4) {
...
Packet CreateImagePacket(mediapipe_custom::ImageFormat::Format format,
                         const py::array& data, bool copy) {
  if (format == mediapipe_custom::ImageFormat::SRGB ||
      format == mediapipe_custom::ImageFormat::SRGBA ||
      format == mediapipe_custom::ImageFormat::GRAY8) {
