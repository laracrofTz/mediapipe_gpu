...
#include "mediapipe_custom/tasks/cc/genai/inference/utils/xnn_utils/pack_weights_cache.h"
...
#include "mediapipe_custom/tasks/cc/genai/inference/utils/xnn_utils/named_buffer_generated.h"
  ...
  return std::visit(
      absl::Overload(
          [](const std::string& filename) {
            return mediapipe_custom::file::Exists(filename).ok()
  ...
  return std::visit(
      absl::Overload(
          [&data](const std::string& filename) {
            return mediapipe_custom::file::AppendStringToFile(filename, data);
          },
