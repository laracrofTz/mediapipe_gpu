...
PoseLandmarkerResult ConvertToPoseLandmarkerResult(
    std::optional<std::vector<mediapipe_custom::Image>> segmentation_masks,
    const std::vector<mediapipe_custom::NormalizedLandmarkList>& pose_landmarks_proto,
    const std::vector<mediapipe_custom::LandmarkList>& pose_world_landmarks_proto) {
