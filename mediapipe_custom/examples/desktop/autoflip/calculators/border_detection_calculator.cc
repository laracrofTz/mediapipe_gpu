...
#include "mediapipe_custom/examples/desktop/autoflip/calculators/border_detection_calculator.pb.h"
...
absl::Status BorderDetectionCalculator::Open(mediapipe_custom::CalculatorContext* cc) {
...
absl::Status BorderDetectionCalculator::Process(
  ...
  cv::Mat frame = mediapipe_custom::formats::MatView(
