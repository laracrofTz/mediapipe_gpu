...
#include "mediapipe_custom/calculators/tensor/tensor_to_joints_calculator.h"

#include <utility>

#include "mediapipe_custom/calculators/tensor/tensor_to_joints_calculator.pb.h"
...
class TensorToJointsCalculatorImpl
    : public mediapipe_custom::api2::NodeImpl<TensorToJointsCalculator> {
 public:
