...
#include "mediapipe_custom/framework/deps/strong_int.h"
...
#define MEDIAPIPE_DEFINE_SAFE_INT_TYPE(type_name, value_type, policy_type) \
  ...
  typedef mediapipe_custom::intops::StrongInt<                                    \
      type_name##_safe_tag_, value_type,                                   \
      mediapipe_custom::intops::SafeIntStrongIntValidator<policy_type>>           \
      type_name;
