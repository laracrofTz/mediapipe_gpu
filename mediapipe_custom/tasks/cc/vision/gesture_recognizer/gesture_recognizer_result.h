...
struct GestureRecognizerResult {
  ...
  std::vector<mediapipe_custom::ClassificationList> gestures;
  // Classification of handedness.
  std::vector<mediapipe_custom::ClassificationList> handedness;
  // Detected hand landmarks in normalized image coordinates.
  std::vector<mediapipe_custom::NormalizedLandmarkList> hand_landmarks;
  // Detected hand landmarks in world coordinates.
  std::vector<mediapipe_custom::LandmarkList> hand_world_landmarks;
};
