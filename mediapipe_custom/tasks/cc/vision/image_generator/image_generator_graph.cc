...
#include "mediapipe_custom/framework/tool/switch_container.pb.h"
...
#include "mediapipe_custom/tasks/cc/vision/image_generator/diffuser/stable_diffusion_iterate_calculator.pb.h"
#include "mediapipe_custom/tasks/cc/vision/image_generator/proto/conditioned_image_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/image_generator/proto/control_plugin_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/vision/image_generator/proto/image_generator_graph_options.pb.h"
...
class ConditionedImageGraphContainer : public core::ModelTaskGraph {
 public:
  absl::StatusOr<CalculatorGraphConfig> GetConfig(
    ...
    auto& switch_options =
        switch_container.GetOptions<mediapipe_custom::SwitchContainerOptions>();
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::image_generator::ConditionedImageGraphContainer); // NOLINT
// clang-format on
 ...
 public:
  absl::StatusOr<CalculatorGraphConfig> GetConfig(
    ...
    auto& image_to_tensor_options =
        image_to_tensor.GetOptions<mediapipe_custom::ImageToTensorCalculatorOptions>();
    ...
    plugins_inference.GetOptions<mediapipe_custom::InferenceCalculatorOptions>()
        .mutable_delegate()
        ->mutable_xnnpack();
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::image_generator::ControlPluginGraph);
...
class ImageGeneratorGraph : public core::ModelTaskGraph {
 public:
  ...
  absl::StatusOr<ImageGeneratorOutputs> BuildImageGeneratorGraph(
    ...
    mediapipe_custom::StableDiffusionIterateCalculatorOptions& options =
        stable_diff
            .GetOptions<mediapipe_custom::StableDiffusionIterateCalculatorOptions>();
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::image_generator::ImageGeneratorGraph);
