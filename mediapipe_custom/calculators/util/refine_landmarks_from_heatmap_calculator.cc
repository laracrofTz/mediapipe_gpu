...
#include "mediapipe_custom/calculators/util/refine_landmarks_from_heatmap_calculator.h"
...
class RefineLandmarksFromHeatmapCalculatorImpl
 ...
 public:
  ...
  absl::Status Process(CalculatorContext* cc) override {
    ...
    const auto& options =
        cc->Options<mediapipe_custom::RefineLandmarksFromHeatmapCalculatorOptions>();
...
absl::StatusOr<mediapipe_custom::NormalizedLandmarkList> RefineLandmarksFromHeatMap(
    const mediapipe_custom::NormalizedLandmarkList& in_lms,
  ...
  mediapipe_custom::NormalizedLandmarkList out_lms = in_lms;
