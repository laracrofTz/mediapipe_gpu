...
#include "mediapipe_custom/framework/formats/affine_transform.h"
...
using ::mediapipe_custom::AffineTransformData;
...
MEDIAPIPE_REGISTER_TYPE(mediapipe_custom::AffineTransform,
                        "::mediapipe_custom::AffineTransform", nullptr, nullptr);
