...
#include "mediapipe_custom/calculators/util/resource_provider_calculator.h"
...
#include "mediapipe_custom/calculators/util/resource_provider_calculator.pb.h"
...
#include "mediapipe_custom/util/resources_test_util.h"
...
TEST(ResourceProviderCalculatorTest, CanGetMultipleResourcesUsingSidePackets) {
  constexpr int kNumResources = 3;
  absl::flat_hash_map<std::string, std::string> resources_in_memory;
  std::map<std::string, mediapipe_custom::Packet> resource_ids_side_packets;
