...
float ApplyActivation(
    ::mediapipe_custom::TensorsToLandmarksCalculatorOptions::Activation activation,
    float value) {
  switch (activation) {
    case ::mediapipe_custom::TensorsToLandmarksCalculatorOptions::SIGMOID:
...
class TensorsToLandmarksCalculator : public Node {
 ...
 private:
  ...
  ::mediapipe_custom::TensorsToLandmarksCalculatorOptions options_;
};
...
absl::Status TensorsToLandmarksCalculator::LoadOptions(CalculatorContext* cc) {
  ...
  options_ = cc->Options<::mediapipe_custom::TensorsToLandmarksCalculatorOptions>();
