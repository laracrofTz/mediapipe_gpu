...
TEST(ConvertFromProto, Succeeds) {
  mediapipe_custom::ClassificationList classification_list_proto;
  mediapipe_custom::Classification& classification_proto =
  ...
  mediapipe_custom::LandmarkList landmark_list_proto;
  mediapipe_custom::Landmark& landmark_proto = *landmark_list_proto.add_landmark();
  landmark_proto.set_x(3.1);
  landmark_proto.set_y(5.2);
  landmark_proto.set_z(4.3);

  std::vector<mediapipe_custom::ClassificationList> classification_lists = {
  ...
  std::vector<mediapipe_custom::LandmarkList> landmarks_lists = {landmark_list_proto};
