...
#include "mediapipe_custom/framework/stream_handler/timestamp_align_input_stream_handler.h"
...
#include "mediapipe_custom/framework/stream_handler/timestamp_align_input_stream_handler.pb.h"
...
TimestampAlignInputStreamHandler::TimestampAlignInputStreamHandler(
  ...
  const auto& handler_options = options.GetExtension(
      mediapipe_custom::TimestampAlignInputStreamHandlerOptions::ext);
  std::string tag;
  int index;
