...
#include "mediapipe_custom/tasks/c/vision/face_detector/face_detector.h"
...
#include "mediapipe_custom/tasks/c/components/containers/detection_result_converter.h"
...
#include "mediapipe_custom/tasks/cc/vision/face_detector/face_detector.h"
#include "mediapipe_custom/tasks/cc/vision/utils/image_utils.h"

namespace mediapipe_custom::tasks::c::vision::face_detector {

namespace {

using ::mediapipe_custom::tasks::c::components::containers::CppCloseDetectionResult;
...
using ::mediapipe_custom::tasks::vision::face_detector::FaceDetector;
typedef ::mediapipe_custom::tasks::vision::face_detector::FaceDetectorResult
...
void CppConvertToFaceDetectorOptions(
    ...
    mediapipe_custom::tasks::vision::face_detector::FaceDetectorOptions* out) {
...
FaceDetector* CppFaceDetectorCreate(const FaceDetectorOptions& options,
  ...
  auto cpp_options = std::make_unique<
      ::mediapipe_custom::tasks::vision::face_detector::FaceDetectorOptions>();
...
void* face_detector_create(struct FaceDetectorOptions* options,
                           char** error_msg) {
  return mediapipe_custom::tasks::c::vision::face_detector::CppFaceDetectorCreate(
      *options, error_msg);
}

int face_detector_detect_image(void* detector, const MpImage* image,
                               FaceDetectorResult* result, char** error_msg) {
  return mediapipe_custom::tasks::c::vision::face_detector::CppFaceDetectorDetect(
...
int face_detector_detect_for_video(void* detector, const MpImage* image,
                                   ...
                                   FaceDetectorResult* result,
                                   char** error_msg) {
  return mediapipe_custom::tasks::c::vision::face_detector::
...
int face_detector_detect_async(void* detector, const MpImage* image,
                               int64_t timestamp_ms, char** error_msg) {
  return mediapipe_custom::tasks::c::vision::face_detector::CppFaceDetectorDetectAsync(
      detector, image, timestamp_ms, error_msg);
}

void face_detector_close_result(FaceDetectorResult* result) {
  mediapipe_custom::tasks::c::vision::face_detector::CppFaceDetectorCloseResult(
      result);
}

int face_detector_close(void* detector, char** error_ms) {
  return mediapipe_custom::tasks::c::vision::face_detector::CppFaceDetectorClose(
      detector, error_ms);
}
