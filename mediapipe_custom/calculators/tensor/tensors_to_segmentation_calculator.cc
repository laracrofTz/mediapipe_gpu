...
#include "mediapipe_custom/calculators/tensor/tensors_to_segmentation_converter_gl_buffer.h"
#elif MEDIAPIPE_METAL_ENABLED
#include "mediapipe_custom/calculators/tensor/tensors_to_segmentation_converter_metal.h"
...
#include "mediapipe_custom/calculators/tensor/tensors_to_segmentation_converter_opencv.h"
...
using ::mediapipe_custom::tensors_to_segmentation_utils::CanUseGpu;
...
class TensorsToSegmentationCalculator : public Node {
 ...
 private:
  ...
  mediapipe_custom::TensorsToSegmentationCalculatorOptions options_;
...
absl::Status TensorsToSegmentationCalculator::LoadOptions(
  ...
  options_ = cc->Options<mediapipe_custom::TensorsToSegmentationCalculatorOptions>();
