...
#include "mediapipe_custom/calculators/video/flow_to_image_calculator.pb.h"
#include "mediapipe_custom/calculators/video/tool/flow_quantizer_model.h"
...
#include "mediapipe_custom/framework/formats/motion/optical_flow_field.h"
...
absl::Status FlowToImageCalculator::Process(CalculatorContext* cc) {
  ...
  cv::Mat image = ::mediapipe_custom::formats::MatView(output.get());
