...
#include "mediapipe_custom/tasks/cc/components/processors/embedding_postprocessing_graph.h"
...
#include "mediapipe_custom/tasks/cc/components/calculators/tensors_to_embeddings_calculator.pb.h"
#include "mediapipe_custom/tasks/cc/components/containers/proto/embeddings.pb.h"
#include "mediapipe_custom/tasks/cc/components/processors/proto/embedder_options.pb.h"
#include "mediapipe_custom/tasks/cc/components/processors/proto/embedding_postprocessing_graph_options.pb.h"
...
using ::mediapipe_custom::tasks::components::containers::proto::EmbeddingResult;
...
// more details.
class EmbeddingPostprocessingGraph : public mediapipe_custom::Subgraph {
 public:
 ...
 private:
  ...
  // (std::vector<mediapipe_custom::Tensor>) as input and returns one output stream
  ...
  BuildEmbeddingPostprocessing(
    ...
    tensors_to_embeddings_node
        .GetOptions<mediapipe_custom::TensorsToEmbeddingsCalculatorOptions>()
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::components::processors::EmbeddingPostprocessingGraph);
