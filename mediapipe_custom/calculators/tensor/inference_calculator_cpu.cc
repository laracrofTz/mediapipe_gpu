...
#include "mediapipe_custom/calculators/tensor/inference_calculator_utils.h"
#include "mediapipe_custom/calculators/tensor/inference_interpreter_delegate_runner.h"
...
InferenceCalculatorCpuImpl::MaybeCreateDelegate(CalculatorContext* cc) {
  const auto& calculator_opts =
      cc->Options<mediapipe_custom::InferenceCalculatorOptions>();
