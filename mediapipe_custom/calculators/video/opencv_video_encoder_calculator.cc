...
#include "mediapipe_custom/calculators/video/opencv_video_encoder_calculator.pb.h"
...
absl::Status OpenCvVideoEncoderCalculator::Open(CalculatorContext* cc) {
  ...
  four_cc_ = mediapipe_custom::fourcc(codec_array[0], codec_array[1], codec_array[2],
                               codec_array[3]);
