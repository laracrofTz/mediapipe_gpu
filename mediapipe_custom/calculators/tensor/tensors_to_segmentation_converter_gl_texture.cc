...
#include "mediapipe_custom/calculators/tensor/tensors_to_segmentation_converter_gl_texture.h"
...
void main() {
  ...
  fragColor = out_value;
    ...
    mediapipe_custom::GlhCreateProgram(
        mediapipe_custom::kBasicVertexShader, shader_src_no_previous.c_str(),
