...
using ::mediapipe_custom::api2::builder::ConvertDetectionsToRectUsingKeypoints;
using ::mediapipe_custom::api2::builder::ConvertDetectionToRect;
...
using ::mediapipe_custom::api2::builder::Scale;
