...
using mediapipe_custom::ClassificationList;
using mediapipe_custom::LandmarkList;
using mediapipe_custom::NormalizedLandmarkList;

void InitGestureRecognizerResult(
    ::mediapipe_custom::tasks::vision::gesture_recognizer::GestureRecognizerResult*
        cpp_result) {
  // Initialize gestures
  mediapipe_custom::Classification classification_for_gestures;
  ...
  *gestures_list.add_classification() = classification_for_gestures;
  ...
  mediapipe_custom::Classification classification_for_handedness;
