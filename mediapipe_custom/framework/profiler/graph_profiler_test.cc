...
class GraphProfilerTestPeer : public testing::Test {
 public:
  ...
  void InitializeProfilerWithGraphConfig(const std::string& raw_graph_config) {
    ...
    mediapipe_custom::ValidatedGraphConfig validated_graph;
...
TEST_F(GraphProfilerTestPeer, PauseResumeReset) {
  ...
  std::shared_ptr<mediapipe_custom::SimulationClock> simulation_clock(
      new SimulationClock());
...
// mediapipe_custom::ProcessProfile::set_total"
