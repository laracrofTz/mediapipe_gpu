 ...
 */
- (std::optional<mediapipe_custom::tasks::core::PacketMap>)processImage:(MPPImage *)image
                                                           error:(NSError **)error;
 ...
 * @return An optional `PacketMap` containing pairs of output stream name and data packet.
 */
- (std::optional<mediapipe_custom::tasks::core::PacketMap>)processVideoFrame:(MPPImage *)videoFrame
 ...
 */
- (std::optional<std::map<std::string, mediapipe_custom::Packet>>)
