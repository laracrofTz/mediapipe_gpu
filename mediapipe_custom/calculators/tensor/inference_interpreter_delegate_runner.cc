...
#include "mediapipe_custom/calculators/tensor/inference_feedback_manager.h"
...
#include "mediapipe_custom/calculators/tensor/tflite_delegate_ptr.h"
...
CreateInferenceInterpreterDelegateRunner(
    ...
    const mediapipe_custom::InferenceCalculatorOptions::InputOutputConfig*
        input_output_config,
    bool enable_zero_copy_tensor_io) {
