...
template <typename T>
class Vector2
    : public mediapipe_custom::deps::internal_vector::BasicVector<Vector2, T, 2> {
 private:
  using Base = mediapipe_custom::deps::internal_vector::BasicVector<::Vector2, T, 2>;
  using VType = T;
...
template <typename T>
class Vector3
    : public mediapipe_custom::deps::internal_vector::BasicVector<Vector3, T, 3> {
 private:
  using Base = mediapipe_custom::deps::internal_vector::BasicVector<::Vector3, T, 3>;
  using VType = T;
...
template <typename T>
class Vector4
    : public mediapipe_custom::deps::internal_vector::BasicVector<Vector4, T, 4> {
 private:
  using Base = mediapipe_custom::deps::internal_vector::BasicVector<::Vector4, T, 4>;
  using VType = T;
