...
#include "mediapipe_custom/calculators/core/graph_profile_calculator.pb.h"
...
// mediapipe_custom::GraphProfiler::CaptureProfile to the "PROFILE" output stream.
//
...
class GraphProfileCalculator : public Node {
 public:
  ...
  absl::Status Process(CalculatorContext* cc) final {
    auto options = cc->Options<::mediapipe_custom::GraphProfileCalculatorOptions>();
