...
from mediapipe_custom.tasks.cc.vision.hand_landmarker.proto import hand_landmarker_graph_options_pb2
...
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.vision.hand_landmarker.HandLandmarkerGraph'
