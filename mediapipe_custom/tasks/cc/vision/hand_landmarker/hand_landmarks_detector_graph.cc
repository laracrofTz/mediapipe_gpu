...
using ::mediapipe_custom::tasks::vision::hand_landmarker::proto::
...
void ConfigureTensorsToHandednessCalculator(
    mediapipe_custom::TensorsToClassificationCalculatorOptions* options) {
  options->set_top_k(1);
...
class SingleHandLandmarksDetectorGraph : public core::ModelTaskGraph {
 ...
 private:
  ...
  // image_in: (mediapipe_custom::Image) stream to run hand landmark detection on.
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::hand_landmarker::SingleHandLandmarksDetectorGraph); // NOLINT
// clang-format on
...
// clang-format off
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::hand_landmarker::MultipleHandLandmarksDetectorGraph); // NOLINT
// clang-format on
