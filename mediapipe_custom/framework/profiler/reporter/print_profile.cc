...
int main(int argc, char** argv) {
  ...
  for (const auto& file_name : flags_logfiles) {
    ...
    mediapipe_custom::proto_ns::io::IstreamInputStream isis(&ifs);
    mediapipe_custom::proto_ns::io::CodedInputStream coded_input_stream(&isis);
    mediapipe_custom::GraphProfile proto;
