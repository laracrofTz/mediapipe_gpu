...
class StaticAccessToStatusHandlerTyped : public StaticAccessToStatusHandler {
 public:
  static_assert(
      ...
      "mediapipe_custom::StatusHandler.");
  static_assert(
...
#define REGISTER_STATUS_HANDLER(name)                           \
  REGISTER_FACTORY_FUNCTION_QUALIFIED(                          \
      mediapipe_custom::internal::StaticAccessToStatusHandlerRegistry, \
      status_handler_registration, name,                        \
      std::make_unique<                                         \
          mediapipe_custom::internal::StaticAccessToStatusHandlerTyped<name>>)
