...
```
load("//mediapipe_custom/java/com/google/mediapipe:mediapipe_aar.bzl", "mediapipe_aar")

mediapipe_aar(
    name = "demo",
    calculators = ["//mediapipe_custom/calculators/core:pass_through_calculator"],
)
```
...
""",
    ...
    deps = [
        ...
        "//mediapipe_custom/framework/tool:calculator_graph_template_java_proto_lite",
        "//mediapipe_custom/java/com/google/mediapipe/components:android_components",
        "//mediapipe_custom/java/com/google/mediapipe/components:android_camerax_helper",
        ...
        "//mediapipe_custom/java/com/google/mediapipe/glutil",
    ...
    deps += select({
        ...
        "//mediapipe_custom/framework/port:disable_opencv": [],
    ...
    android_library(
        ...
        srcs = srcs + [
                   "//mediapipe_custom/java/com/google/mediapipe/components:java_src",
                   "//mediapipe_custom/java/com/google/mediapipe/framework:java_src",
                   "//mediapipe_custom/java/com/google/mediapipe/glutil:java_src",
        ...
        proguard_specs = ["//mediapipe_custom/java/com/google/mediapipe/framework:proguard.pgcfg"],
        deps = deps,
        assets = assets,
...
def _mediapipe_jni(name, gen_libmediapipe, calculators = []):
    ...
    if gen_libmediapipe:
        native.cc_binary(
            ...
            linkstatic = 1,
            deps = [
                "//mediapipe_custom/java/com/google/mediapipe/framework/jni:mediapipe_framework_jni",
            ] + calculators,
        )
