...
TEST(FilterDetectionsCalculatorTest, TestFilterDetectionsScore) {
  ...
  EXPECT_THAT(output_detections, ElementsAre(mediapipe_custom::EqualsProto(d2)));
}
...
TEST(FilterDetectionsCalculatorTest, TestFilterDetectionsScoreMultiple) {
  ...
  EXPECT_THAT(output_detections, ElementsAre(mediapipe_custom::EqualsProto(d3),
                                             mediapipe_custom::EqualsProto(d4)));
}
...
TEST(FilterDetectionsCalculatorTest, TestFilterDetectionsMinSize) {
  ...
  EXPECT_THAT(output_detections, ElementsAre(mediapipe_custom::EqualsProto(d1),
                                             mediapipe_custom::EqualsProto(d3),
                                             mediapipe_custom::EqualsProto(d5)));
}
