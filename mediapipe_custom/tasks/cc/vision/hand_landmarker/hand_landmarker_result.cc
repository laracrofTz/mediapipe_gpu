...
HandLandmarkerResult ConvertToHandLandmarkerResult(
    const std::vector<mediapipe_custom::ClassificationList>& handedness_proto,
    const std::vector<mediapipe_custom::NormalizedLandmarkList>& hand_landmarks_proto,
    const std::vector<mediapipe_custom::LandmarkList>& hand_world_landmarks_proto) {
