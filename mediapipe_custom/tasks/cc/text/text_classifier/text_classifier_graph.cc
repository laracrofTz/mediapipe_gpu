...
#include "mediapipe_custom/tasks/cc/text/text_classifier/proto/text_classifier_graph_options.pb.h"
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::text::text_classifier::TextClassifierGraph);
