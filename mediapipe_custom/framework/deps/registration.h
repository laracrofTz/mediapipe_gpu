...
#include "mediapipe_custom/framework/deps/registration_token.h"
...
class FunctionRegistry {
 public:
  ...
  std::string GetNormalizedName(absl::string_view name) {
    using ::mediapipe_custom::registration_internal::kCxxSep;
  ...
  std::string GetQualifiedName(absl::string_view ns,
    ...
    using ::mediapipe_custom::registration_internal::kCxxSep;
    using ::mediapipe_custom::registration_internal::kNameSep;
...
#define MEDIAPIPE_REGISTER_FACTORY_FUNCTION_QUALIFIED(RegistryType, var_name, \
                                                      name, ...)              \
  static mediapipe_custom::RegistrationToken* REGISTRY_STATIC_VAR(var_name,          \
                                                           __LINE__) = []() { \
...
#define MEDIAPIPE_STATIC_REGISTRATOR_TEMPLATE(RegistratorName, RegistryType,  \
  ...
  struct Internal##RegistratorName {                                          \
    static NoDestructor<mediapipe_custom::RegistrationToken> registration;           \
                                                                              \
    static mediapipe_custom::RegistrationToken Make() {                              \
      ABSL_RAW_LOG(WARNING, "Registration Dry Run: %s",                       \
                   INTERNAL_MEDIAPIPE_REGISTER_FACTORY_STRINGIFY(             \
  ...
  template <typename T>                                                       \
  NoDestructor<mediapipe_custom::RegistrationToken>                                  \
...
#define MEDIAPIPE_REGISTER_FACTORY_FUNCTION_QUALIFIED(RegistryType, var_name, \
  ...
  static mediapipe_custom::RegistrationToken* REGISTRY_STATIC_VAR(var_name,          \
                                                           __LINE__) =        \
      new mediapipe_custom::RegistrationToken(                                       \
          RegistryType::Register(name, __VA_ARGS__));
