...
#include "mediapipe_custom/tasks/cc/components/processors/embedder_options.h"
#include "mediapipe_custom/tasks/cc/components/processors/proto/embedder_options.pb.h"
#include "mediapipe_custom/tasks/cc/components/utils/cosine_similarity.h"
...
using ::mediapipe_custom::tasks::components::containers::ConvertToEmbeddingResult;
using ::mediapipe_custom::tasks::components::containers::proto::EmbeddingResult;
using ::mediapipe_custom::tasks::core::PacketMap;
using ::mediapipe_custom::tasks::vision::image_embedder::proto::
