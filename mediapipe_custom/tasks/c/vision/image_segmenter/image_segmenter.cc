...
#include "mediapipe_custom/tasks/c/vision/image_segmenter/image_segmenter.h"
...
#include "mediapipe_custom/tasks/c/vision/image_segmenter/image_segmenter_result.h"
#include "mediapipe_custom/tasks/c/vision/image_segmenter/image_segmenter_result_converter.h"
...
namespace mediapipe_custom::tasks::c::vision::image_segmenter {
...
using ::mediapipe_custom::tasks::vision::image_segmenter::ImageSegmenter;
typedef ::mediapipe_custom::tasks::vision::image_segmenter::ImageSegmenterResult
...
void CppConvertToImageSegmenterOptions(
    ...
    mediapipe_custom::tasks::vision::image_segmenter::ImageSegmenterOptions* out) {
...
ImageSegmenter* CppImageSegmenterCreate(const ImageSegmenterOptions& options,
  ...
  auto cpp_options = std::make_unique<
      ::mediapipe_custom::tasks::vision::image_segmenter::ImageSegmenterOptions>();
...
void* image_segmenter_create(struct ImageSegmenterOptions* options,
                             char** error_msg) {
  return mediapipe_custom::tasks::c::vision::image_segmenter::CppImageSegmenterCreate(
      *options, error_msg);
}
...
int image_segmenter_segment_image(void* segmenter, const MpImage* image,
                                  ImageSegmenterResult* result,
                                  char** error_msg) {
  return mediapipe_custom::tasks::c::vision::image_segmenter::CppImageSegmenterSegment(
...
int image_segmenter_segment_for_video(void* segmenter, const MpImage* image,
                                      ...
                                      ImageSegmenterResult* result,
                                      char** error_msg) {
  return mediapipe_custom::tasks::c::vision::image_segmenter::
...
void image_segmenter_close_result(ImageSegmenterResult* result) {
  mediapipe_custom::tasks::c::vision::image_segmenter::CppImageSegmenterCloseResult(
      result);
}

int image_segmenter_close(void* segmenter, char** error_ms) {
  return mediapipe_custom::tasks::c::vision::image_segmenter::CppImageSegmenterClose(
      segmenter, error_ms);
}
