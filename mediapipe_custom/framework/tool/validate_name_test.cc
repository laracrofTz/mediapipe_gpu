...
TEST(ValidateNameTest, ParseTagIndexName) {
  ...
  TestPassParseTagIndexName(
      absl::StrCat("A1:", mediapipe_custom::internal::kMaxCollectionItemId, ":mieko1"),
      "A1", mediapipe_custom::internal::kMaxCollectionItemId, "mieko1");
  ...
  TestFailParseTagIndexName(
      absl::StrCat("A:", mediapipe_custom::internal::kMaxCollectionItemId + 1,
