...
#include "mediapipe_custom/calculators/audio/rational_factor_resample_calculator.h"
...
#include "mediapipe_custom/calculators/audio/rational_factor_resample_calculator.pb.h"
...
class RationalFactorResampleCalculatorTest
 ...
 protected:
  ...
  void CheckOutputHeaders(double output_sample_rate) {
    ...
    EXPECT_THAT(output_header, mediapipe_custom::EqualsProto(expected_header));
  }
