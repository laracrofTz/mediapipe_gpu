...
#include "mediapipe_custom/tasks/cc/vision/holistic_landmarker/holistic_face_tracking.h"
...
#include "mediapipe_custom/framework/api2/stream/split.h"
...
using ::mediapipe_custom::api2::builder::SplitToRanges;
...
mediapipe_custom::LandmarksToRenderDataCalculatorOptions GetFaceRendererOptions() {
...
mediapipe_custom::RectToRenderDataCalculatorOptions GetRectRendererOptions() {
  mediapipe_custom::RectToRenderDataCalculatorOptions render_options;
...
absl::StatusOr<std::unique_ptr<tasks::core::TaskRunner>> CreateTaskRunner() {
  ...
  Stream<mediapipe_custom::NormalizedLandmarkList> pose_landmarks =
