...
#include "mediapipe_custom/calculators/tensor/audio_to_tensor_calculator.pb.h"
...
#include "mediapipe_custom/tasks/cc/audio/audio_classifier/proto/audio_classifier_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/audio/utils/audio_tensor_specs.h"
...
class AudioClassifierGraph : public core::ModelTaskGraph {
 ...
 private:
  ...
  // buffer (mediapipe_custom::Matrix) and the corresponding sample rate (double) as
  ...
  // audio_in: (mediapipe_custom::Matrix) stream to run audio classification on.
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::audio::audio_classifier::AudioClassifierGraph);
