...
#include "mediapipe_custom/calculators/tensor/bert_preprocessor_calculator.pb.h"
#include "mediapipe_custom/calculators/tensor/regex_preprocessor_calculator.pb.h"
...
namespace mediapipe_custom::tasks::components::processors {
namespace {
...
// more details.
class TextPreprocessingGraph : public mediapipe_custom::Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::components::processors::TextPreprocessingGraph);
