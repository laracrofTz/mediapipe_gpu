...
REGISTER_CALCULATOR(::mediapipe_custom::test_ns::DeadEndCalculator);
...
REGISTER_CALCULATOR(::mediapipe_custom::EndCalculator);
...
// DeadEndCalculator is registered in namespace "mediapipe_custom::test_ns".
...
TEST(CalculatorTest, CreateByNameWhitelisted) {
  ...
  *const_cast<absl::flat_hash_set<std::string>*>(
      ...
      "mediapipe_custom::test_ns::whitelisted_ns",
      "mediapipe",
  };

  // Register a whitelisted calculator.
  CalculatorBaseRegistry::Register(
      "::mediapipe_custom::test_ns::whitelisted_ns::DeadCalculator",
