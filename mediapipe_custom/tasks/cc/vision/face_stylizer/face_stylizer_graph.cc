...
#include "mediapipe_custom/calculators/util/landmarks_to_detection_calculator.pb.h"
...
#include "mediapipe_custom/tasks/cc/vision/face_stylizer/calculators/tensors_to_image_calculator.pb.h"
#include "mediapipe_custom/tasks/cc/vision/face_stylizer/proto/face_stylizer_graph_options.pb.h"
...
using ::mediapipe_custom::tasks::TensorsToImageCalculatorOptions;
...
using ::mediapipe_custom::tasks::vision::face_stylizer::proto::
...
void ConfigureTensorsToImageCalculator(
  ...
  tensors_to_image_options->set_gpu_origin(mediapipe_custom::GpuOrigin_Mode_TOP_LEFT);
...
//
// Outputs:
//   STYLIZED_IMAGE - mediapipe_custom::Image
//     The face stylization output image.
//   FACE_ALIGNMENT - mediapipe_custom::Image
  ...
  absl::StatusOr<FaceStylizerOutputStreams> BuildFaceStylizerGraph(
    ...
    if (!output_stylized) {
      ...
      image_to_tensor_options.set_border_mode(
          mediapipe_custom::ImageToTensorCalculatorOptions::BORDER_ZERO);
    ...
    image_converter.GetOptions<mediapipe_custom::ImageCloneCalculatorOptions>()
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe_custom::tasks::vision::face_stylizer::FaceStylizerGraph);  // NOLINT
// clang-format on
