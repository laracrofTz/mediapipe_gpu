...
#include "mediapipe_custom/tasks/c/components/containers/category.h"
#include "mediapipe_custom/tasks/c/components/containers/category_converter.h"
#include "mediapipe_custom/tasks/c/components/containers/landmark.h"
#include "mediapipe_custom/tasks/c/components/containers/landmark_converter.h"
...
using CppCategory = ::mediapipe_custom::tasks::components::containers::Category;
using CppLandmark = ::mediapipe_custom::tasks::components::containers::Landmark;
...
void CppConvertToGestureRecognizerResult(
    const mediapipe_custom::tasks::vision::gesture_recognizer::GestureRecognizerResult&
        in,
