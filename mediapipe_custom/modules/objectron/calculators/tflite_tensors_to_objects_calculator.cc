...
#include "mediapipe_custom/modules/objectron/calculators/tflite_tensors_to_objects_calculator.pb.h"
...
class TfLiteTensorsToObjectsCalculator : public CalculatorBase {
 ...
 private:
  ...
  ::mediapipe_custom::TfLiteTensorsToObjectsCalculatorOptions options_;
...
absl::Status TfLiteTensorsToObjectsCalculator::LoadOptions(
  ...
  options_ =
      cc->Options<::mediapipe_custom::TfLiteTensorsToObjectsCalculatorOptions>();
