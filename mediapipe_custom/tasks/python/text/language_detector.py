...
from mediapipe_custom.tasks.cc.text.text_classifier.proto import text_classifier_graph_options_pb2
...
_TEXT_TAG = 'TEXT'
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.text.text_classifier.TextClassifierGraph'
