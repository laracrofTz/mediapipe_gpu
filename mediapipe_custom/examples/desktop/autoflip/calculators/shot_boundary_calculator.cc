...
#include "mediapipe_custom/examples/desktop/autoflip/calculators/shot_boundary_calculator.pb.h"
...
using mediapipe_custom::ImageFrame;
...
//  }
class ShotBoundaryCalculator : public mediapipe_custom::CalculatorBase {
 public:
 ...
 private:
  ...
  void Transmit(mediapipe_custom::CalculatorContext* cc, bool is_shot_change);
  // Calculator options.
...
absl::Status ShotBoundaryCalculator::Open(mediapipe_custom::CalculatorContext* cc) {
...
void ShotBoundaryCalculator::Transmit(mediapipe_custom::CalculatorContext* cc,
                                      bool is_shot_change) {
...
absl::Status ShotBoundaryCalculator::Process(mediapipe_custom::CalculatorContext* cc) {
  // Connect to input frame and make a mutable copy.
  cv::Mat frame_org = mediapipe_custom::formats::MatView(
