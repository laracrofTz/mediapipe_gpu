...
#include "mediapipe_custom/calculators/core/vector_size_calculator.h"
...
using LandmarkListVectorSizeCalculator =
    VectorSizeCalculator<mediapipe_custom::LandmarkList>;
REGISTER_CALCULATOR(LandmarkListVectorSizeCalculator);

using ClassificationListVectorSizeCalculator =
    VectorSizeCalculator<mediapipe_custom::ClassificationList>;
