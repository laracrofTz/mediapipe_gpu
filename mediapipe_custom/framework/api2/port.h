...
#include "mediapipe_custom/framework/api2/const_str.h"
...
#include "mediapipe_custom/framework/tool/type_util.h"
...
InputShardAccess<ValueT> SinglePortAccess(mediapipe_custom::CalculatorContext* cc,
                                          InputStreamShard* stream) {
  return InputShardAccess<ValueT>(*cc, stream);
}

template <typename ValueT>
OutputShardAccess<ValueT> SinglePortAccess(mediapipe_custom::CalculatorContext* cc,
...
InputSidePacketAccess<ValueT> SinglePortAccess(
    mediapipe_custom::CalculatorContext* cc, const mediapipe_custom::Packet* packet) {
  return InputSidePacketAccess<ValueT>(packet);
}

template <typename ValueT>
OutputSidePacketAccess<ValueT> SinglePortAccess(
    mediapipe_custom::CalculatorContext* cc, OutputSidePacket* osp) {
  return OutputSidePacketAccess<ValueT>(osp);
}

template <typename ValueT>
InputShardOrSideAccess<ValueT> SinglePortAccess(
    mediapipe_custom::CalculatorContext* cc, InputStreamShard* stream,
    const mediapipe_custom::Packet* packet) {
  return InputShardOrSideAccess<ValueT>(*cc, stream, packet);
}

template <typename ValueT>
PacketTypeAccess SinglePortAccess(mediapipe_custom::CalculatorContract* cc,
                                  PacketType* pt);

template <typename ValueT>
PacketTypeAccessFallback SinglePortAccess(mediapipe_custom::CalculatorContract* cc,
...
class PortCommon : public Base {
 ...
 private:
  ...
  friend class mediapipe_custom::api2::SideFallbackT;
};
...
class OutputShardAccess : public OutputShardAccessBase {
 ...
 private:
  ...
  friend OutputShardAccess<T> internal::SinglePortAccess<T>(
      mediapipe_custom::CalculatorContext*, OutputStreamShard*);
};
...
class OutputShardAccess<internal::Generic> : public OutputShardAccessBase {
 ...
 private:
  ...
  internal::SinglePortAccess<internal::Generic>(mediapipe_custom::CalculatorContext*,
                                                OutputStreamShard*);
};
...
class OutputSidePacketAccess {
 ...
 private:
  ...
  friend OutputSidePacketAccess<T> internal::SinglePortAccess<T>(
      mediapipe_custom::CalculatorContext*, OutputSidePacket*);
};
...
class InputShardAccess : public Packet<T> {
 ...
 private:
  ...
  friend InputShardAccess<T> internal::SinglePortAccess<T>(
      mediapipe_custom::CalculatorContext*, InputStreamShard*);
};
...
class InputSidePacketAccess : public Packet<T> {
 ...
 private:
  InputSidePacketAccess(const mediapipe_custom::Packet* packet)
  ...
  friend InputSidePacketAccess<T> internal::SinglePortAccess<T>(
      mediapipe_custom::CalculatorContext*, const mediapipe_custom::Packet*);
};
...
class PacketTypeAccess {
 ...
 protected:
  ...
  friend PacketTypeAccess internal::SinglePortAccess(
      mediapipe_custom::CalculatorContract*, PacketType*);
};
...
class PacketTypeAccessFallback : public PacketTypeAccess {
 ...
 private:
  ...
  friend PacketTypeAccessFallback internal::SinglePortAccess(
      mediapipe_custom::CalculatorContract*, PacketType*, bool);
};
