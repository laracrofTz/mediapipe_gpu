...
#include "mediapipe_custom/tasks/c/components/containers/landmark.h"
#include "mediapipe_custom/tasks/c/vision/hand_landmarker/hand_landmarker_result.h"
#include "mediapipe_custom/tasks/cc/components/containers/category.h"
...
namespace mediapipe_custom::tasks::c::components::containers {

void InitHandLandmarkerResult(
    ::mediapipe_custom::tasks::vision::hand_landmarker::HandLandmarkerResult*
        cpp_result) {
  // Initialize handedness
  mediapipe_custom::tasks::components::containers::Category cpp_category = {
      /* index= */ 1,
      /* score= */ 0.8f,
      /* category_name= */ "handeness_label_1",
      /* display_name= */ "handeness_display_name_1"};
  mediapipe_custom::tasks::components::containers::Classifications
  ...
  mediapipe_custom::tasks::components::containers::NormalizedLandmark
      cpp_normalized_landmark = {/* x= */ 0.1f,
                                 /* y= */ 0.2f,
                                 /* z= */ 0.3f};
  mediapipe_custom::tasks::components::containers::NormalizedLandmarks
  ...
  mediapipe_custom::tasks::components::containers::Landmark cpp_landmark = {
      /* x= */ 1.0f,
      /* y= */ 1.1f,
      /* z= */ 1.2f};
  mediapipe_custom::tasks::components::containers::Landmarks cpp_landmarks;
...
TEST(HandLandmarkerResultConverterTest, ConvertsCustomResult) {
  ::mediapipe_custom::tasks::vision::hand_landmarker::HandLandmarkerResult cpp_result;
