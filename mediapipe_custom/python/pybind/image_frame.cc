...
#include "mediapipe_custom/python/pybind/image_frame_util.h"
#include "mediapipe_custom/python/pybind/util.h"
...
void ImageFrameSubmodule(pybind11::module* module) {
  ...
  // ImageFormat
  py::enum_<mediapipe_custom::ImageFormat::Format> image_format(
      m, "ImageFormat",
  ...
  image_format.value("SRGB", mediapipe_custom::ImageFormat::SRGB)
      .value("SRGBA", mediapipe_custom::ImageFormat::SRGBA)
      .value("SBGRA", mediapipe_custom::ImageFormat::SBGRA)
      .value("GRAY8", mediapipe_custom::ImageFormat::GRAY8)
      .value("GRAY16", mediapipe_custom::ImageFormat::GRAY16)
      .value("SRGB48", mediapipe_custom::ImageFormat::SRGB48)
      .value("SRGBA64", mediapipe_custom::ImageFormat::SRGBA64)
      .value("VEC32F1", mediapipe_custom::ImageFormat::VEC32F1)
      .value("VEC32F2", mediapipe_custom::ImageFormat::VEC32F2)
      .export_values();
  ...
  image_frame
      .def(
          py::init([](mediapipe_custom::ImageFormat::Format format,
                      const py::array_t<uint8_t, py::array::c_style>& data) {
            if (format != mediapipe_custom::ImageFormat::GRAY8 &&
      ...
      .def(
          py::init([](mediapipe_custom::ImageFormat::Format format,
            ...
            if (format != mediapipe_custom::ImageFormat::GRAY16 &&
                format != mediapipe_custom::ImageFormat::SRGB48 &&
                format != mediapipe_custom::ImageFormat::SRGBA64) {
              throw RaisePyError(
                  PyExc_RuntimeError,
      ...
      .def(
          py::init([](mediapipe_custom::ImageFormat::Format format,
            ...
            if (format != mediapipe_custom::ImageFormat::VEC32F1 &&
                format != mediapipe_custom::ImageFormat::VEC32F2) {
              throw RaisePyError(
                  PyExc_RuntimeError,
...
MEDIAPIPE_REGISTER_TYPE(mediapipe_custom::ImageFrame, "::mediapipe_custom::ImageFrame",
                        nullptr, nullptr);
