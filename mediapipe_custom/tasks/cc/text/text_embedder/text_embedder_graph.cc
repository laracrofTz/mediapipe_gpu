...
#include "mediapipe_custom/tasks/cc/components/processors/proto/text_preprocessing_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/components/processors/text_preprocessing_graph.h"
#include "mediapipe_custom/tasks/cc/core/model_resources.h"
#include "mediapipe_custom/tasks/cc/core/model_task_graph.h"
#include "mediapipe_custom/tasks/cc/core/proto/model_resources_calculator.pb.h"
#include "mediapipe_custom/tasks/cc/text/text_embedder/proto/text_embedder_graph_options.pb.h"
#include "mediapipe_custom/tasks/cc/text/utils/text_model_utils.h"

namespace mediapipe_custom::tasks::text::text_embedder {
namespace {
...
using ::mediapipe_custom::tasks::text::utils::GetModelType;
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::text::text_embedder::TextEmbedderGraph);
