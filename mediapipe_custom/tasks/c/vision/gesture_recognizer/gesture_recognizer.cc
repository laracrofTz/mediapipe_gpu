...
#include "mediapipe_custom/tasks/c/vision/gesture_recognizer/gesture_recognizer.h"
...
#include "mediapipe_custom/tasks/c/vision/gesture_recognizer/gesture_recognizer_result.h"
#include "mediapipe_custom/tasks/c/vision/gesture_recognizer/gesture_recognizer_result_converter.h"
...
#include "mediapipe_custom/tasks/cc/vision/gesture_recognizer/gesture_recognizer_result.h"
#include "mediapipe_custom/tasks/cc/vision/utils/image_utils.h"

namespace mediapipe_custom::tasks::c::vision::gesture_recognizer {
...
using ::mediapipe_custom::tasks::vision::gesture_recognizer::GestureRecognizer;
typedef ::mediapipe_custom::tasks::vision::gesture_recognizer::GestureRecognizerResult
...
void CppConvertToGestureRecognizerOptions(
    ...
    mediapipe_custom::tasks::vision::gesture_recognizer::GestureRecognizerOptions*
        out) {
...
GestureRecognizer* CppGestureRecognizerCreate(
  ...
  auto cpp_options =
      std::make_unique<::mediapipe_custom::tasks::vision::gesture_recognizer::
...
void* gesture_recognizer_create(struct GestureRecognizerOptions* options,
                                char** error_msg) {
  return mediapipe_custom::tasks::c::vision::gesture_recognizer::
...
void gesture_recognizer_close_result(GestureRecognizerResult* result) {
  mediapipe_custom::tasks::c::vision::gesture_recognizer::
