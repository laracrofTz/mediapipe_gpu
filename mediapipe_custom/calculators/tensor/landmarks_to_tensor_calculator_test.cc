...
void RunLandmarks(mediapipe_custom::CalculatorRunner* runner,
...
void RunNormLandmarks(mediapipe_custom::CalculatorRunner* runner,
...
const Tensor& GetOutputTensor(mediapipe_custom::CalculatorRunner* runner) {
