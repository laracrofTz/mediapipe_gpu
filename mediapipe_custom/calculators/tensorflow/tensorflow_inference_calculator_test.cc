...
std::string GetGraphDefPath() {
  ...
  return mediapipe_custom::file::JoinPath(path, "testdata/frozen_graph_def.pb");
#elif defined(__ANDROID__)
  char path[1024];
  getcwd(path, sizeof(path));
  return mediapipe_custom::file::JoinPath(path,
                                   "mediapipe/calculators/tensorflow/"
                                   "testdata/frozen_graph_def.pb");
#else
  return mediapipe_custom::file::JoinPath(
      ::testing::SrcDir(),
