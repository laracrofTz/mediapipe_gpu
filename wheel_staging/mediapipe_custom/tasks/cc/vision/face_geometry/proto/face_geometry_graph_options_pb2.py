...
from mediapipe_custom.tasks.cc.vision.face_geometry.calculators import geometry_pipeline_calculator_pb2 as mediapipe_dot_tasks_dot_cc_dot_vision_dot_face__geometry_dot_calculators_dot_geometry__pipeline__calculator__pb2
