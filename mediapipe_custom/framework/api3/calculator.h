...
#include "mediapipe_custom/framework/api3/internal/contract_validator.h"
...
class Calculator : public CalculatorBase,
 ...
 public:
  ...
  absl::Status Open(mediapipe_custom::CalculatorContext* cc) final {
    context_.emplace(*cc);
  ...
  absl::Status Close(mediapipe_custom::CalculatorContext* cc) final {
    context_->Reset(*cc);
