...
#include "mediapipe_custom/calculators/audio/stabilized_log_calculator.pb.h"
#include "mediapipe_custom/calculators/audio/two_tap_fir_filter_calculator.pb.h"
...
class TwoTapFirFilterCalculator : public Node {
 public:
  ...
  absl::Status Open(CalculatorContext* cc) override {
    auto audio_header = std::make_unique<mediapipe_custom::TimeSeriesHeader>();
    MP_RETURN_IF_ERROR(mediapipe_custom::time_series_util::FillTimeSeriesHeaderIfValid(
