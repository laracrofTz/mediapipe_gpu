...
#include "mediapipe_custom/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.pb.h"
#include "mediapipe_custom/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.pb.h"
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::hand_landmarker::HandLandmarkerGraph);
