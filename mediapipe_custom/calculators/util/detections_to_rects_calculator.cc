...
#include "mediapipe_custom/calculators/util/detections_to_rects_calculator.h"
...
absl::Status DetectionsToRectsCalculator::DetectionToRect(
  ...
  switch (options_.conversion_mode()) {
    case mediapipe_custom::DetectionsToRectsCalculatorOptions_ConversionMode_DEFAULT:
