...
void PublicPacketGetters(pybind11::module* m) {
  ...
  Args:
    packet: A MediaPipe Packet that holds std:vector<mediapipe_custom::Image>.

  Returns:
    A list of MediaPipe Images.

  Raises:
    ValueError: If the Packet doesn't contain std:vector<mediapipe_custom::Image>.
  ...
  Args:
    packet: A MediaPipe Packet that holds std:vector<mediapipe_custom::ImageFrame>.
  ...
  Raises:
    ValueError: If the Packet doesn't contain std:vector<mediapipe_custom::ImageFrame>.
