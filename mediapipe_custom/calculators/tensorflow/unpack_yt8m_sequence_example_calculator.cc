...
#include "mediapipe_custom/calculators/tensorflow/lapped_tensor_buffer_calculator.pb.h"
  ...
  static absl::Status GetContract(CalculatorContract* cc) {
    ...
    if (cc->OutputSidePackets().HasTag(kLappedTensorBufferCalculatorOptions)) {
      cc->OutputSidePackets()
          ...
          .Set<::mediapipe_custom::LappedTensorBufferCalculatorOptions>();
    }
    ...
    if (cc->OutputSidePackets().HasTag(kLappedTensorBufferCalculatorOptions) ||
      ...
      if (cc->OutputSidePackets().HasTag(
        ...
        auto lapped_tensor_buffer_calculator_options = absl::make_unique<
            ::mediapipe_custom::LappedTensorBufferCalculatorOptions>();
