...
#include "mediapipe_custom/tasks/cc/vision/image_classifier/image_classifier.h"
...
#include "mediapipe_custom/tasks/cc/components/processors/classifier_options.h"
...
using ::mediapipe_custom::tasks::components::containers::ConvertToClassificationResult;
