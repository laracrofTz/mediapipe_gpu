...
#include "mediapipe_custom/tasks/cc/vision/image_segmenter/calculators/segmentation_postprocessor_gl.h"
...
using ::mediapipe_custom::ImageFrameSharedPtr;
using ::mediapipe_custom::api2::Input;
using ::mediapipe_custom::api2::Node;
using ::mediapipe_custom::api2::Output;
using ::mediapipe_custom::tasks::TensorsToSegmentationCalculatorOptions;
using ::mediapipe_custom::tasks::vision::GetImageLikeTensorShape;
using ::mediapipe_custom::tasks::vision::Shape;
...
Image ProcessForCategoryMaskCpu(const Shape& input_shape,
  ...
  cv::Mat category_mask_mat_view =
      mediapipe_custom::formats::MatView(image_frame_ptr.get());
...
std::vector<Image> ProcessForConfidenceMaskCpu(const Shape& input_shape,
  ...
  for (int i = 0; i < input_shape.channels; ++i) {
    ...
    confidence_mask_mats.push_back(mediapipe_custom::formats::MatView(
...
MEDIAPIPE_REGISTER_NODE(::mediapipe_custom::tasks::TensorsToSegmentationCalculator);
