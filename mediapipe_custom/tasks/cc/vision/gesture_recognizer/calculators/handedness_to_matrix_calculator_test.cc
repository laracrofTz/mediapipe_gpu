...
mediapipe_custom::ClassificationList ClassificationForHandedness(float handedness) {
  mediapipe_custom::ClassificationList result;
...
TEST_P(HandednessToMatrixCalculatorTest, OutputsCorrectResult) {
  ...
  auto input_handedness = std::make_unique<mediapipe_custom::ClassificationList>();
