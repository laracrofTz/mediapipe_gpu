...
struct ABSL_DEPRECATED(
    "Prefer using mediapipe_custom::tool::TagMap instead, since this structure does "
    "not "
...
ABSL_DEPRECATED(
    "Prefer using mediapipe_custom::tool::TagMap instead, since this method does not "
