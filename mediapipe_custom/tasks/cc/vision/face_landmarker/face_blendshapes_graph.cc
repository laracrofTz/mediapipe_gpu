...
#include "mediapipe_custom/calculators/tensor/landmarks_to_tensor_calculator.h"
...
using ::mediapipe_custom::api2::LandmarksToTensorCalculator;
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::face_landmarker::FaceBlendshapesGraph);
