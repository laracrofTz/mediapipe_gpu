...
#include "Halide.h"
#include "mediapipe_custom/util/frame_buffer/halide/common.h"

namespace {

using ::Halide::BoundaryConditions::repeat_edge;
using ::mediapipe_custom::frame_buffer::halide::common::is_interleaved;
using ::mediapipe_custom::frame_buffer::halide::common::is_planar;
using ::mediapipe_custom::frame_buffer::halide::common::resize_bilinear_int;
