...
#include "mediapipe_custom/tasks/cc/vision/image_classifier/proto/image_classifier_graph_options.pb.h"
...
class ImageClassifierGraph : public core::ModelTaskGraph {
 ...
 private:
  ...
  // (mediapipe_custom::Image) as input and returns one classification result per input
  // image.
  //
  ...
  // image_in: (mediapipe_custom::Image) stream to run classification on.
