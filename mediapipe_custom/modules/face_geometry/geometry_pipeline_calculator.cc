...
#include "mediapipe_custom/modules/face_geometry/geometry_pipeline_calculator.pb.h"
#include "mediapipe_custom/modules/face_geometry/libs/geometry_pipeline.h"
...
#include "mediapipe_custom/modules/face_geometry/protos/geometry_pipeline_metadata.pb.h"
...
class GeometryPipelineCalculator : public CalculatorBase {
 public:
  ...
  absl::Status Process(CalculatorContext* cc) override {
    ...
    cc->Outputs()
        .Tag(kMultiFaceGeometryTag)
        .AddPacket(mediapipe_custom::Adopt<std::vector<face_geometry::FaceGeometry>>(
 ...
 private:
  ...
  ReadMetadataFromFile(CalculatorContext* cc,
    ...
    MP_ASSIGN_OR_RETURN(std::unique_ptr<mediapipe_custom::Resource> metadata_blob,
