...
#include "mediapipe_custom/tasks/cc/text/language_detector/custom_ops/utils/hash/murmur.h"
#include "mediapipe_custom/tasks/cc/text/language_detector/custom_ops/utils/ngram_hash_ops_utils.h"
#include "tensorflow/lite/kernels/kernel_util.h"
#include "tensorflow/lite/string_util.h"

namespace mediapipe_custom::tflite_operations {
...
using ::mediapipe_custom::tasks::text::language_detector::custom_ops::
    LowercaseUnicodeStr;
using ::mediapipe_custom::tasks::text::language_detector::custom_ops::Tokenize;
using ::mediapipe_custom::tasks::text::language_detector::custom_ops::TokenizedOutput;
using ::mediapipe_custom::tasks::text::language_detector::custom_ops::hash::
