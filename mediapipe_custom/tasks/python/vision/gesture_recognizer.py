...
from mediapipe_custom.tasks.cc.vision.gesture_recognizer.proto import gesture_recognizer_graph_options_pb2
...
from mediapipe_custom.tasks.python.components.processors import classifier_options
...
_TASK_GRAPH_NAME = (
    'mediapipe_custom.tasks.vision.gesture_recognizer.GestureRecognizerGraph'
)
