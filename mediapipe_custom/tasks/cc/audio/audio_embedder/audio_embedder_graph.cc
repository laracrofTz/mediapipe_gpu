...
#include "mediapipe_custom/tasks/cc/audio/audio_embedder/proto/audio_embedder_graph_options.pb.h"
...
namespace mediapipe_custom::tasks::audio::audio_embedder {
namespace {
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::audio::audio_embedder::AudioEmbedderGraph);
