...
#include "mediapipe_custom/tasks/cc/vision/hand_detector/proto/hand_detector_result.pb.h"
...
using ::mediapipe_custom::tasks::vision::hand_detector::proto::HandDetectorResult;
