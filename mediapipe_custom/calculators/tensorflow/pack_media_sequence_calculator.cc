...
#include "mediapipe_custom/calculators/image/opencv_image_encoder_calculator.pb.h"
#include "mediapipe_custom/calculators/tensorflow/pack_media_sequence_calculator.pb.h"
...
#include "mediapipe_custom/framework/formats/location_opencv.h"
#include "mediapipe_custom/framework/port/opencv_imgcodecs_inc.h"
#include "mediapipe_custom/framework/port/ret_check.h"
#include "mediapipe_custom/util/sequence/media_sequence.h"
#include "mediapipe_custom/util/sequence/media_sequence_util.h"
...
namespace mpms = mediapipe_custom::mediasequence;
...
//   mediapipe_custom::Detection. In the input Detection, the score field is required,
 ...
 public:
  ...
  absl::Status VerifySequence() {
    ...
    if (all_present) {
      ...
      return ::mediapipe_custom::NotFoundErrorBuilder(MEDIAPIPE_LOC) << error_msg;
    }
  }
