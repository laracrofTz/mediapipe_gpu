...
#include "mediapipe_custom/tasks/cc/vision/object_detector/proto/object_detector_options.pb.h"
...
class ObjectDetectorGraph : public core::ModelTaskGraph {
 ...
 private:
  ...
  // (mediapipe_custom::Image) as the input and returns two output streams:
  ...
  // image_in: (mediapipe_custom::Image) stream to run object detection on.
...
REGISTER_MEDIAPIPE_GRAPH(::mediapipe_custom::tasks::vision::ObjectDetectorGraph);
