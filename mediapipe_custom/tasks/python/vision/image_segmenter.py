...
from mediapipe_custom.tasks.cc.vision.image_segmenter.calculators import tensors_to_segmentation_calculator_pb2
from mediapipe_custom.tasks.cc.vision.image_segmenter.proto import image_segmenter_graph_options_pb2
from mediapipe_custom.tasks.cc.vision.image_segmenter.proto import segmenter_options_pb2
...
_TENSORS_TO_SEGMENTATION_CALCULATOR_NAME = (
    'mediapipe_custom.tasks.TensorsToSegmentationCalculator'
)
_TASK_GRAPH_NAME = 'mediapipe_custom.tasks.vision.image_segmenter.ImageSegmenterGraph'
