...
from mediapipe_custom.tasks.cc.metadata.python import _pywrap_metadata_version
...
from mediapipe_custom.tasks.python.metadata.flatbuffers_lib import _pywrap_flatbuffers
