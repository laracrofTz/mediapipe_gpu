...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@mediapipe_custom/hands/hands.js" crossorigin="anonymous"></script>
</head>
...
const hands = new Hands({locateFile: (file) => {
  return `https://cdn.jsdelivr.net/npm/@mediapipe_custom/hands/${file}`;
}});
hands.setOptions({
  maxNumHands: 2,
  modelComplexity: 1,
