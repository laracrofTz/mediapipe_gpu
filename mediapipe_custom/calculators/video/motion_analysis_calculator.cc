...
#include "mediapipe_custom/calculators/video/motion_analysis_calculator.pb.h"
...
#include "mediapipe_custom/util/tracking/camera_motion.h"
#include "mediapipe_custom/util/tracking/camera_motion.pb.h"
#include "mediapipe_custom/util/tracking/frame_selection.pb.h"
#include "mediapipe_custom/util/tracking/motion_analysis.h"
#include "mediapipe_custom/util/tracking/motion_estimation.h"
#include "mediapipe_custom/util/tracking/motion_models.h"
#include "mediapipe_custom/util/tracking/region_flow.pb.h"
...
using mediapipe_custom::AffineAdapter;
using mediapipe_custom::CameraMotion;
using mediapipe_custom::FrameSelectionResult;
using mediapipe_custom::Homography;
using mediapipe_custom::HomographyAdapter;
using mediapipe_custom::LinearSimilarityModel;
using mediapipe_custom::MixtureHomography;
using mediapipe_custom::MixtureRowWeights;
using mediapipe_custom::MotionAnalysis;
using mediapipe_custom::ProjectViaFit;
using mediapipe_custom::RegionFlowComputationOptions;
using mediapipe_custom::RegionFlowFeatureList;
using mediapipe_custom::SalientPointFrame;
using mediapipe_custom::TranslationModel;
