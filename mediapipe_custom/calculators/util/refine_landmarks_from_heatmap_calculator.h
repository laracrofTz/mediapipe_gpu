...
class RefineLandmarksFromHeatmapCalculator : public NodeIntf {
 public:
  static constexpr Input<mediapipe_custom::NormalizedLandmarkList> kInLandmarks{
      "NORM_LANDMARKS"};
  static constexpr Input<std::vector<Tensor>> kInTensors{"TENSORS"};
  static constexpr Output<mediapipe_custom::NormalizedLandmarkList> kOutLandmarks{
      "NORM_LANDMARKS"};
