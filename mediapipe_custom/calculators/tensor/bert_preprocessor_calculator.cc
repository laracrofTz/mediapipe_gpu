...
#include "mediapipe_custom/tasks/cc/text/tokenizers/tokenizer.h"
...
using ::mediapipe_custom::tasks::core::FindTensorIndexByMetadataName;
...
absl::Status BertPreprocessorCalculator::UpdateContract(
  ...
  const auto& options =
      cc->Options<mediapipe_custom::BertPreprocessorCalculatorOptions>();
