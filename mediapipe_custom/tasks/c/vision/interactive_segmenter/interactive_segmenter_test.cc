...
#include "mediapipe_custom/tasks/c/test/test_utils.h"
...
using ::mediapipe_custom::tasks::c::test::CreateCategoryMaskFromImage;
using ::mediapipe_custom::tasks::c::test::SimilarToUint8Mask;
