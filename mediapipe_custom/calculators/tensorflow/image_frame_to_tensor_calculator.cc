...
#include "mediapipe_custom/calculators/tensorflow/image_frame_to_tensor_calculator.pb.h"
...
std::unique_ptr<tf::Tensor> ImageFrameToNormalizedTensor(
    ...
    const mediapipe_custom::proto_ns::RepeatedField<float>& mean,
    const mediapipe_custom::proto_ns::RepeatedField<float>& stddev) {
