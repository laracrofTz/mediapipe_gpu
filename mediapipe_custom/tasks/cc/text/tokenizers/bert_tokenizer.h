...
#include "mediapipe_custom/tasks/cc/text/utils/vocab_utils.h"
#include "re2/re2.h"
...
class BertTokenizer : public mediapipe_custom::tasks::text::tokenizers::Tokenizer {
 public:
  ...
  explicit BertTokenizer(const std::string& path_to_vocab,
                         const BertTokenizerOptions& options = {})
      : BertTokenizer(mediapipe_custom::tasks::text::LoadVocabFromFile(path_to_vocab),
                      options) {}
  ...
  BertTokenizer(const char* vocab_buffer_data, size_t vocab_buffer_size,
                const BertTokenizerOptions& options = {})
      : BertTokenizer(mediapipe_custom::tasks::text::LoadVocabFromBuffer(
 ...
 private:
  mediapipe_custom::tasks::text::tokenizers::FlatHashMapBackedWordpiece vocab_;
