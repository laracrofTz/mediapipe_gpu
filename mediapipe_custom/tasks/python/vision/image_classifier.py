...
from mediapipe_custom.tasks.cc.components.containers.proto import classifications_pb2
from mediapipe_custom.tasks.cc.components.processors.proto import classifier_options_pb2
from mediapipe_custom.tasks.cc.vision.image_classifier.proto import image_classifier_graph_options_pb2
from mediapipe_custom.tasks.python.components.containers import classification_result as classification_result_module
from mediapipe_custom.tasks.python.components.containers import rect
...
from mediapipe_custom.tasks.python.vision.core import vision_task_running_mode
...
_TASK_GRAPH_NAME = (
    'mediapipe_custom.tasks.vision.image_classifier.ImageClassifierGraph'
)
