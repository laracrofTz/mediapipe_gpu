...
#include "mediapipe_custom/framework/tool/options_field_util.h"
...
using ::mediapipe_custom::proto_ns::internal::WireFormatLite;
...
bool HasField(const FieldPath& field_path, const FieldData& message_data) {
  ...
  return value.ok() &&
         value->value_case() != mediapipe_custom::FieldData::VALUE_NOT_SET;
}
...
void SetOptionsMessage(
    ...
    proto_ns::RepeatedPtrField<mediapipe_custom::protobuf::Any>* result) {
