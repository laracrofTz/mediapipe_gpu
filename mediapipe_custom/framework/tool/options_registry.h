...
#include "mediapipe_custom/framework/tool/field_data.pb.h"
...
using FieldType = mediapipe_custom::proto_ns::internal::WireFormatLite::FieldType;
using mediapipe_custom::FieldData;
