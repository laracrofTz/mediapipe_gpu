 ...
 * runner.
 */
@property(nonatomic, readonly) const mediapipe_custom::CalculatorGraphConfig &graphConfig;
...
- (instancetype)initWithTaskInfo:(MPPTaskInfo *)taskInfo
                 packetsCallback:(mediapipe_custom::tasks::core::PacketsCallback)packetsCallback
 ...
 */
- (std::optional<mediapipe_custom::tasks::core::PacketMap>)
    processPacketMap:(const mediapipe_custom::tasks::core::PacketMap &)packetMap
               error:(NSError **)error;
 ...
 * `MPPVisionTaskRunner`.
 */
- (BOOL)sendPacketMap:(const mediapipe_custom::tasks::core::PacketMap &)packetMap error:(NSError **)error;
