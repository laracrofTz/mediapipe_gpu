...
#include "mediapipe_custom/framework/collection_item_id.h"
...
#include "mediapipe_custom/framework/input_stream_handler.h"
#include "mediapipe_custom/framework/lifetime_tracker.h"
...
#include "mediapipe_custom/framework/tool/sink.h"
...
REGISTER_CALCULATOR(::mediapipe_custom::nested_ns::ProcessCallbackCalculator);
...
TEST(CalculatorGraph, TestPollPacketsWithTimestampNotification) {
  ...
  CalculatorGraphConfig graph_config =
      mediapipe_custom::ParseTextProtoOrDie<CalculatorGraphConfig>(config_str);
...
void DoTestMultipleGraphRuns(absl::string_view input_stream_handler,
  ...
  CalculatorGraphConfig config =
      mediapipe_custom::ParseTextProtoOrDie<CalculatorGraphConfig>(graph_proto);
  std::vector<Packet> packet_dump;
  tool::AddVectorSink("output", &config, &packet_dump);
