...
#include "mediapipe_custom/tasks/cc/components/containers/proto/landmarks_detection_result.pb.h"
...
using ::mediapipe_custom::tasks::components::containers::ConvertToClassifications;
using ::mediapipe_custom::tasks::components::containers::ConvertToNormalizedLandmarks;
using ::mediapipe_custom::tasks::components::containers::RectF;
using ::mediapipe_custom::tasks::containers::proto::LandmarksDetectionResult;
