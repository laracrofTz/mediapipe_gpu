...
"""Tests for mediapipe_custom.python.solution_base."""
...
from mediapipe_custom.python.solution_base import PacketDataType
...
CALCULATOR_OPTIONS_TEST_GRAPH_CONFIG = """
  ...
  node {
    ...
    options: {
      [mediapipe_custom.ImageTransformationCalculatorOptions.ext] {
         output_width: 10
         output_height: 10
      }
    }
    node_options: {
      [type.googleapis.com/mediapipe_custom.ImageTransformationCalculatorOptions] {
         output_width: 10
         output_height: 10
      }
    }
  ...
  def test_valid_input_data_type_audio(self):
    text_config = """
      ...
      node {
        ...
        output_stream: "output_audio"
        options {
          [mediapipe_custom.ResampleTimeSeriesCalculatorOptions.ext] {
