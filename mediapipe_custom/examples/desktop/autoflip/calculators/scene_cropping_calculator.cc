...
#include "mediapipe_custom/examples/desktop/autoflip/calculators/scene_cropping_calculator.h"
...
#include "mediapipe_custom/examples/desktop/autoflip/quality/scene_cropping_viz.h"
#include "mediapipe_custom/examples/desktop/autoflip/quality/utils.h"
...
bool HasFrameSignal(mediapipe_custom::CalculatorContext* cc) {
  if (cc->Inputs().HasTag(kInputVideoFrames)) {
...
absl::Status SceneCroppingCalculator::Close(mediapipe_custom::CalculatorContext* cc) {
