...
#include "mediapipe_custom/tasks/c/components/containers/detection_result.h"
#include "mediapipe_custom/tasks/c/components/containers/keypoint.h"
#include "mediapipe_custom/tasks/c/components/containers/keypoint_converter.h"
#include "mediapipe_custom/tasks/c/components/containers/rect_converter.h"
...
void CppConvertToDetection(
    const mediapipe_custom::tasks::components::containers::Detection& in,
    ::Detection* out) {
...
void CppConvertToDetectionResult(
    const mediapipe_custom::tasks::components::containers::DetectionResult& in,
    ::DetectionResult* out) {
