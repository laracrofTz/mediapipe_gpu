...
TEST(BypassCalculatorTest, SubgraphChannel) {
  CalculatorGraphConfig config_1 =
      mediapipe_custom::ParseTextProtoOrDie<CalculatorGraphConfig>(kTestGraphConfig1);
  CalculatorGraphConfig config_2 =
      mediapipe_custom::ParseTextProtoOrDie<CalculatorGraphConfig>(kTestGraphConfig2);
...
TEST(BypassCalculatorTest, CalculatorChannel) {
  CalculatorGraphConfig config_3 =
      mediapipe_custom::ParseTextProtoOrDie<CalculatorGraphConfig>(kTestGraphConfig3);
  CalculatorGraph graph;
...
TEST(BypassCalculatorTest, GatedChannel) {
  CalculatorGraphConfig config_3 =
      mediapipe_custom::ParseTextProtoOrDie<CalculatorGraphConfig>(kTestGraphConfig4);
  CalculatorGraph graph;
  MP_ASSERT_OK(graph.Initialize({config_3}, {}));
