...
using ::mediapipe_custom::api2::SideInput;
using ::mediapipe_custom::api2::SideOutput;
using ::mediapipe_custom::api2::builder::GenericNode;
using ::mediapipe_custom::api2::builder::Graph;
using ::mediapipe_custom::tasks::core::proto::Acceleration;
using ::mediapipe_custom::tasks::core::proto::InferenceSubgraphOptions;
using ::mediapipe_custom::tasks::core::proto::ModelResourcesCalculatorOptions;
...
class InferenceSubgraph : public Subgraph {
 public:
  absl::StatusOr<CalculatorGraphConfig> GetConfig(
    ...
    inference_node.GetOptions<mediapipe_custom::InferenceCalculatorOptions>()
        .mutable_delegate()
 ...
 private:
  absl::StatusOr<mediapipe_custom::InferenceCalculatorOptions::Delegate>
  DecideInferenceSettings(const InferenceSubgraphOptions& options) {
    ...
    mediapipe_custom::InferenceCalculatorOptions::Delegate delegate;
...
REGISTER_MEDIAPIPE_GRAPH(::mediapipe_custom::tasks::core::InferenceSubgraph)
