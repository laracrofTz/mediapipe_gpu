...
typedef ConcatenateVectorCalculator<::mediapipe_custom::NormalizedLandmark>
    ConcatenateLandmarkVectorCalculator;
MEDIAPIPE_REGISTER_NODE(ConcatenateLandmarkVectorCalculator);

typedef ConcatenateVectorCalculator<::mediapipe_custom::LandmarkList>
    ConcatenateLandmarkListVectorCalculator;
MEDIAPIPE_REGISTER_NODE(ConcatenateLandmarkListVectorCalculator);

typedef ConcatenateVectorCalculator<::mediapipe_custom::NormalizedLandmarkList>
...
typedef ConcatenateVectorCalculator<mediapipe_custom::ClassificationList>
...
typedef ConcatenateVectorCalculator<mediapipe_custom::RenderData>
    ConcatenateRenderDataVectorCalculator;
MEDIAPIPE_REGISTER_NODE(ConcatenateRenderDataVectorCalculator);

typedef ConcatenateVectorCalculator<mediapipe_custom::Image>
