...
#include "mediapipe_custom/calculators/util/landmarks_transformation_calculator.pb.h"
...
class LandmarksTransformationCalculator : public NodeIntf {
 public:
  static constexpr Input<mediapipe_custom::LandmarkList> kInLandmarks{"LANDMARKS"};
  static constexpr Input<
      mediapipe_custom::LandmarksTransformationCalculatorOptions>::Optional kInOptions{
      "OPTIONS"};
  static constexpr Output<mediapipe_custom::LandmarkList> kOutLandmarks{"LANDMARKS"};
