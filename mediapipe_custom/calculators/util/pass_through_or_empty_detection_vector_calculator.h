...
class PassThroughOrEmptyDetectionVectorCalculator
    : public mediapipe_custom::api2::NodeIntf {
 public:
  static constexpr mediapipe_custom::api2::Input<std::vector<mediapipe_custom::Detection>>
      kInputVector{"VECTOR"};
  static constexpr mediapipe_custom::api2::Input<mediapipe_custom::api2::AnyType> kTick{
      "TICK"};
  static constexpr mediapipe_custom::api2::Output<std::vector<mediapipe_custom::Detection>>
      kOutputVector{"VECTOR"};

  MEDIAPIPE_NODE_INTERFACE(
      ::mediapipe_custom::PassThroughOrEmptyDetectionVectorCalculator, kInputVector,
      kTick, kOutputVector);
};

template <typename TickT>
api2::builder::Stream<std::vector<mediapipe_custom::Detection>>
PassThroughOrEmptyDetectionVector(
    api2::builder::Stream<std::vector<mediapipe_custom::Detection>> detections,
    api2::builder::Stream<TickT> tick, mediapipe_custom::api2::builder::Graph& graph) {
  auto& node =
