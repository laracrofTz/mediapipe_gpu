...
#include "mediapipe_custom/tasks/cc/vision/holistic_landmarker/holistic_hand_tracking.h"
#include "mediapipe_custom/tasks/cc/vision/holistic_landmarker/holistic_pose_tracking.h"
...
#include "mediapipe_custom/tasks/cc/vision/pose_landmarker/pose_topology.h"
 ...
 public:
  absl::StatusOr<CalculatorGraphConfig> GetConfig(
    ...
    if (face_requested) {
      ...
      Stream<mediapipe_custom::NormalizedLandmarkList> face_landmarks_from_pose =
...
REGISTER_MEDIAPIPE_GRAPH(
    ::mediapipe_custom::tasks::vision::holistic_landmarker::HolisticLandmarkerGraph);
