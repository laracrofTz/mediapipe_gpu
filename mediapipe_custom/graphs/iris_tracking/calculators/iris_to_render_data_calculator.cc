...
#include "mediapipe_custom/graphs/iris_tracking/calculators/iris_to_render_data_calculator.pb.h"
...
absl::Status IrisToRenderDataCalculator::Process(CalculatorContext* cc) {
  ...
  const auto& options =
      cc->Options<::mediapipe_custom::IrisToRenderDataCalculatorOptions>();
